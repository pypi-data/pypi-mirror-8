...
def _resolve_filter_classes(cls_list):
    ...
    _LOG.debug('Found filters: {}'.format(filter_cls_list))
...
def _build_singleton_plfactories(config):
    ...
    _LOG.debug('Gathered filter classes: {}'.format(all_classes))
...
def _build_plfactories(config):
    ...
    _LOG.debug('Gathered upstream filter classes: {}'.format(upstream()))
    _LOG.debug('Gathered downstream filter classes: {}'.format(downstream()))
