...
def main_func():
    ...
    argParser.add_argument('--wrapper-config-file', default="ACServerWrapperConfig.ini", help='The assetto corsa wrapper\'s config file path. If not specified, ACServerWrapperConfig.ini in the current directory will be used (must exist.')
    ...
    if not os.path.isfile(args.wrapper_config_file):
        print (u"Config not found! Sign in to speedwise (http://dev.speedwise.de:8000/gameserver_admins/gameservers/) to get your shared secret and server id and follow the instructions.\n\n Use -h for help.")
        sys.exit(1)
