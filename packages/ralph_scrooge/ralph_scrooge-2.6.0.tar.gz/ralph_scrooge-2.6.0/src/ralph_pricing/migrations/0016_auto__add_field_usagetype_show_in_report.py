...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UsageType.show_in_report'
        db.add_column('ralph_pricing_usagetype', 'show_in_report',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UsageType.show_in_report'
        db.delete_column('ralph_pricing_usagetype', 'show_in_report')
