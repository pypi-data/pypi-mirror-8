...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Device', fields ['sn']
        db.delete_unique('ralph_pricing_device', ['sn'])

        # Removing unique constraint on 'Device', fields ['barcode']
        db.delete_unique('ralph_pricing_device', ['barcode'])


    def backwards(self, orm):
        # Adding unique constraint on 'Device', fields ['barcode']
        db.create_unique('ralph_pricing_device', ['barcode'])

        # Adding unique constraint on 'Device', fields ['sn']
        db.create_unique('ralph_pricing_device', ['sn'])
