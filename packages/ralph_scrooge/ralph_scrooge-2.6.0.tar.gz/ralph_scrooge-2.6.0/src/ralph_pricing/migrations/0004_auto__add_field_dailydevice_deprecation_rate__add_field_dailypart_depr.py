...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyDevice.deprecation_rate'
        db.add_column('ralph_pricing_dailydevice', 'deprecation_rate',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=6),
                      keep_default=False)

        # Adding field 'DailyPart.deprecation_rate'
        db.add_column('ralph_pricing_dailypart', 'deprecation_rate',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DailyDevice.deprecation_rate'
        db.delete_column('ralph_pricing_dailydevice', 'deprecation_rate')

        # Deleting field 'DailyPart.deprecation_rate'
        db.delete_column('ralph_pricing_dailypart', 'deprecation_rate')
