...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TeamVenturePercent', fields ['venture', 'team_daterange']
        db.create_unique('ralph_pricing_teamventurepercent', ['venture_id', 'team_daterange_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TeamVenturePercent', fields ['venture', 'team_daterange']
        db.delete_unique('ralph_pricing_teamventurepercent', ['venture_id', 'team_daterange_id'])
