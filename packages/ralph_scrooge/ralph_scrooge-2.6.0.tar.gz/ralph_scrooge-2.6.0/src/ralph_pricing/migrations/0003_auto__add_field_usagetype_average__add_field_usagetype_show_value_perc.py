...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UsageType.average'
        db.add_column('ralph_pricing_usagetype', 'average',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UsageType.show_value_percentage'
        db.add_column('ralph_pricing_usagetype', 'show_value_percentage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UsageType.show_price_percentage'
        db.add_column('ralph_pricing_usagetype', 'show_price_percentage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UsageType.average'
        db.delete_column('ralph_pricing_usagetype', 'average')

        # Deleting field 'UsageType.show_value_percentage'
        db.delete_column('ralph_pricing_usagetype', 'show_value_percentage')

        # Deleting field 'UsageType.show_price_percentage'
        db.delete_column('ralph_pricing_usagetype', 'show_price_percentage')
