...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyUsage.date'
        db.alter_column('ralph_pricing_dailyusage', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'DailyUsage.date'
        db.alter_column('ralph_pricing_dailyusage', 'date', self.gf('django.db.models.fields.DateField')())
