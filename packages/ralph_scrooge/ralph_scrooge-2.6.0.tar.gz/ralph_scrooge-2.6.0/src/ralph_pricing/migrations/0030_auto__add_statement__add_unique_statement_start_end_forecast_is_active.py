...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ralph_pricing_statement', (
        ...
        db.create_unique('ralph_pricing_statement', ['start', 'end', 'forecast', 'is_active'])


    def backwards(self, orm):
        # Removing unique constraint on 'Statement', fields ['start', 'end', 'forecast', 'is_active']
        db.delete_unique('ralph_pricing_statement', ['start', 'end', 'forecast', 'is_active'])

        # Deleting model 'Statement'
        db.delete_table('ralph_pricing_statement')
