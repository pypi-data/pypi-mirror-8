...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ralph_pricing_service_regular_usage_types', (
        ...
        db.create_unique('ralph_pricing_service_regular_usage_types', ['service_id', 'usagetype_id'])


    def backwards(self, orm):
        # Removing M2M table for field regular_usage_types on 'Service'
        db.delete_table('ralph_pricing_service_regular_usage_types')
