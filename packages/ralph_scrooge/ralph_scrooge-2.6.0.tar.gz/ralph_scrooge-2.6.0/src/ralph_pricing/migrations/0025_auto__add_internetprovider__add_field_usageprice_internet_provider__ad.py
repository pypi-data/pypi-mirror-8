...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('ralph_pricing', ['InternetProvider'])

        # Adding field 'UsagePrice.internet_provider'
        db.add_column('ralph_pricing_usageprice', 'internet_provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_pricing.InternetProvider'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Adding field 'UsageType.by_internet_provider'
        db.add_column('ralph_pricing_usagetype', 'by_internet_provider',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ralph_pricing_internetprovider')
