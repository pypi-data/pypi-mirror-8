...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        try:
            height_of_device = orm.UsageType.objects.get(
                symbol='height_of_device'
            )
            height_of_device.name = 'Collocation'
            height_of_device.symbol = 'collocation'
            height_of_device.save()
        except orm.UsageType.DoesNotExist:
            pass
