...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UsageType.symbol'
        db.add_column('ralph_pricing_usagetype', 'symbol',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UsageType.symbol'
        db.delete_column('ralph_pricing_usagetype', 'symbol')
