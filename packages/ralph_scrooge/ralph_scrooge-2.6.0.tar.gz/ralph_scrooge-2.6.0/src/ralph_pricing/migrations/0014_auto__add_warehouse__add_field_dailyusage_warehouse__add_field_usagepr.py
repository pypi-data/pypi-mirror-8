...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('ralph_pricing', ['Warehouse'])

        # Adding field 'DailyUsage.warehouse'
        db.add_column('ralph_pricing_dailyusage', 'warehouse',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_pricing.Warehouse'], null=True, on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'UsagePrice.forecast_price'
        db.add_column('ralph_pricing_usageprice', 'forecast_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=6),
                      keep_default=False)

        # Adding field 'UsagePrice.cost'
        db.add_column('ralph_pricing_usageprice', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=16, decimal_places=6),
                      keep_default=False)

        # Adding field 'UsagePrice.forecast_cost'
        db.add_column('ralph_pricing_usageprice', 'forecast_cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=16, decimal_places=6),
                      keep_default=False)

        # Adding field 'UsagePrice.warehouse'
        db.add_column('ralph_pricing_usageprice', 'warehouse',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_pricing.Warehouse'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)
        ...
        db.add_column('ralph_pricing_dailydevice', 'warehouse',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_pricing.Warehouse'], null=True, on_delete=models.PROTECT),
                      keep_default=False)
        # Adding field 'DailyDevice.power_consumption'
        db.add_column('ralph_pricing_dailydevice', 'power_consumption',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UsageType.warehouse'
        db.add_column('ralph_pricing_usagetype', 'warehouse',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_pricing.Warehouse'], null=True, on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'UsageType.by_warehouse'
        db.add_column('ralph_pricing_usagetype', 'by_warehouse',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UsageType.by_cost'
        db.add_column('ralph_pricing_usagetype', 'by_cost',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ralph_pricing_warehouse')

        # Deleting field 'DailyUsage.warehouse'
        db.delete_column('ralph_pricing_dailyusage', 'warehouse_id')

        # Deleting field 'UsagePrice.forecast_price'
        db.delete_column('ralph_pricing_usageprice', 'forecast_price')

        # Deleting field 'UsagePrice.cost'
        db.delete_column('ralph_pricing_usageprice', 'cost')

        # Deleting field 'UsagePrice.forecast_cost'
        db.delete_column('ralph_pricing_usageprice', 'forecast_cost')

        # Deleting field 'UsagePrice.warehouse'
        db.delete_column('ralph_pricing_usageprice', 'warehouse_id')

        # Adding unique constraint on 'UsagePrice', fields ['start', 'type']
        db.create_unique('ralph_pricing_usageprice', ['start', 'type_id'])

        # Adding unique constraint on 'UsagePrice', fields ['type', 'end']
        db.create_unique('ralph_pricing_usageprice', ['type_id', 'end'])

        # Deleting field 'DailyDevice.warehouse'
        db.delete_column('ralph_pricing_dailydevice', 'warehouse_id')

        # Deleting field 'DailyDevice.power_consumption'
        db.delete_column('ralph_pricing_dailydevice', 'power_consumption')

        # Deleting field 'UsageType.warehouse'
        db.delete_column('ralph_pricing_usagetype', 'warehouse_id')

        # Deleting field 'UsageType.by_warehouse'
        db.delete_column('ralph_pricing_usagetype', 'by_warehouse')

        # Deleting field 'UsageType.by_cost'
        db.delete_column('ralph_pricing_usagetype', 'by_cost')
    ...
    models = {
        ...
        'ralph_pricing.usagetype': {
            ...
            'symbol': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255'}),
            'warehouse': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ralph_pricing.Warehouse']", 'null': 'True', 'on_delete': 'models.PROTECT'})
        },
