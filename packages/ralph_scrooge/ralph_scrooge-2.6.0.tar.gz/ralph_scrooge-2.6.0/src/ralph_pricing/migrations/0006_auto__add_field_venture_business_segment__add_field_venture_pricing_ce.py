...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ralph_pricing_venture', 'business_segment',
                      self.gf('django.db.models.fields.TextField')(default=u'', max_length=75, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('ralph_pricing_venture', 'business_segment')
    ...
    models = {
        ...
        'ralph_pricing.venture': {
            ...
            'pricing_center': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '75', 'blank': 'True'}),
