...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DailyUsage', fields ['date', 'type', 'pricing_device']
        db.delete_unique('ralph_pricing_dailyusage', ['date', 'type_id', 'pricing_device_id'])

        # Adding unique constraint on 'DailyUsage', fields ['date', 'pricing_venture', 'type', 'pricing_device']
        db.create_unique('ralph_pricing_dailyusage', ['date', 'pricing_venture_id', 'type_id', 'pricing_device_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DailyUsage', fields ['date', 'pricing_venture', 'type', 'pricing_device']
        db.delete_unique('ralph_pricing_dailyusage', ['date', 'pricing_venture_id', 'type_id', 'pricing_device_id'])

        # Adding unique constraint on 'DailyUsage', fields ['date', 'type', 'pricing_device']
        db.create_unique('ralph_pricing_dailyusage', ['date', 'type_id', 'pricing_device_id'])
