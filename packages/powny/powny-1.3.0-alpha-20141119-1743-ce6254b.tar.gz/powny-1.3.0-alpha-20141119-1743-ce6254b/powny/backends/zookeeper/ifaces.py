...
_PATH_SYSTEM = "/system"
_PATH_REQUESTS_COUNTER = zoo.join(_PATH_SYSTEM, "requests_counter")
...
class JobsControl:
    ...
    def __init__(self, client):
        ...
        self._requests_counter = self._client.get_counter(_PATH_REQUESTS_COUNTER)
    ...
    def get_requests_count(self):
        return self._requests_counter.get()

    def add_jobs(self, head, new_jobs):
        request_number = self._requests_counter.increment()
        now = make_isotime()
        added_ids = []
