...
github = 'http://hyperdns.github.io/hapi-client-python3'
...
kwargs = {
    'name' : 'hapi-client',
    'description' : 'HyperDNS HAPI Client Libraries and CLI Tools',
    'namespace_packages': ['hyperdns','hyperdns.hapi'],
    'packages' : ['hyperdns.hapi.client','hyperdns.hapi.client.cli','hyperdns.hapi.sysmgr','hyperdns.hapi.sysmgr.cli'],
    'scripts' : [],
    'entry_points': '''
        [console_scripts]
        hapi=hyperdns.hapi.client.cli:main
    ''',
    'version' : version,
