...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RolePermission.role'
        db.delete_column('m3_users_rolepermissions', 'role_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'RolePermission.role'
        raise RuntimeError("Cannot reverse this migration. 'RolePermission.role' and its values cannot be restored.")
