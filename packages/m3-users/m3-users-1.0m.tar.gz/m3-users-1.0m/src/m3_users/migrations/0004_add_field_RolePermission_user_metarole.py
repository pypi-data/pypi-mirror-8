...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RolePermission.user_metarole'
        db.add_column('m3_users_rolepermissions', 'user_metarole', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['m3_users.UserMetarole'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RolePermission.user_metarole'
        db.delete_column('m3_users_rolepermissions', 'user_metarole_id')
    ...
    models = {
        ...
        'm3_users.rolepermission': {
            ...
            'user_metarole': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['m3_users.UserMetarole']", 'null': 'True'}),
