...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserRole.org'
        db.add_column('m3_users_role', 'org', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserRole.org'
        db.delete_column('m3_users_role', 'org')
