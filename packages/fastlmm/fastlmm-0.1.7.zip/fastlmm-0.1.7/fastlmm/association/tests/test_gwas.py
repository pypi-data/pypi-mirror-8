...
from fastlmm.association.gwas import LeaveOneChromosomeOut, LocoGwas, load_intersect
...
class TestGwas(unittest.TestCase):
    ...
    #def test_results_identical_with_fastlmmcX(self):
    #    """
    ...
    def test_results_identical_with_fastlmmc(self):
        ...
        prefix = r"C:\Users\chwidmer\Documents\Projects\pylmm\src\tests\datasets\mouse"
