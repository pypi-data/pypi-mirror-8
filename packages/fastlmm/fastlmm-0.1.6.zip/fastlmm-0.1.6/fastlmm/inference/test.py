...
class TestFindH2(unittest.TestCase):     
    ...
    def test_two_kernels(self):
        ...
        self.assertAlmostEqual(res1["h2"], res2["h2"])
...
def getTestSuite():
    ...
    suite4 = unittest.TestLoader().loadTestsFromTestCase(TestFindH2)
