...
class HPC: # implements IRunner
    #!!!cmk05192014 LATER make it (and Hadoop) work from root directories -- or give a clear error message
    ...
    def create_run_dir(self):
        ...
        localwd = os.getcwd()
        #!!!cmk04072014 make an option to specify the full remote WD. Also what is the "\\\\" case for?
