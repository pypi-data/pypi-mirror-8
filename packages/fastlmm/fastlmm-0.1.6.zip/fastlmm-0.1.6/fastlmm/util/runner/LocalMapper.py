...
class LocalMapper: # implements IRunner
    ...
    def stream_result(self, work, zgoal, workindex):
        result = run_all_in_memory(work) #!! need to capture all stdout #!!!cmk test this and make a new method for the code that is the same on the two branches of the "if"
