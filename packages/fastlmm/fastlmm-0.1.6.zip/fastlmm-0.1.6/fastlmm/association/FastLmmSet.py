...
class FastLmmSet: # implements IDistributable
    ...
    def __init__(self, **entries):
        ...
        mpheno=0        : integer representing the index of the testing phenotype
	    ...
	    nperm = 2       : number of pemutations per test
        ...
        log             : Level of log messages, e.g. logging.CRITICAL, logging.ERROR, logging.WARNING, logging.INFO
        '''
        ...
        elif not self.hasNonNoneAttr("log"): #If neither were set
            self.log = logging.INFO        
    ...
    def intersect_data(self, covar, pheno):
        if self.check_id_order(covar,pheno):
            ...
            import warnings
            #!!!cmk0407214 warnings.warn("This intersect_ids is deprecated. Pysnptools includes newer versions of intersect_ids", DeprecationWarning)
