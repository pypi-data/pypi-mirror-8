    ...
    def dowork(self, i, train_snp_idx, test_snp_idx, result, G, y):
        ...
        if self.num_pcs == 0:
            ...
            if not self.pc_prefix is None:
                ...
                assert False, "plese precompute PCs"
...
class FastGwas(object):
    ...
    def run_gwas(self):
        ...
        #pv_ = stats.f.sf(chi2stats,1,G.shape[0]-3)#note that G.shape is the number of individuals and 3 is the number of fixed effects (covariates+SNP)
