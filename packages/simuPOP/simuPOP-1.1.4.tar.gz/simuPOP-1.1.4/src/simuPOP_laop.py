...
class sb_RevertFixedSites(BaseOperator):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _simuPOP_laop.sb_RevertFixedSites_swiginit(self,_simuPOP_laop.new_sb_RevertFixedSites(*args, **kwargs))
    __swig_destroy__ = _simuPOP_laop.delete_sb_RevertFixedSites
sb_RevertFixedSites_swigregister = _simuPOP_laop.sb_RevertFixedSites_swigregister
sb_RevertFixedSites_swigregister(sb_RevertFixedSites)

class sb_MutSpaceSelector(BaseSelector):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _simuPOP_laop.sb_MutSpaceSelector_swiginit(self,_simuPOP_laop.new_sb_MutSpaceSelector(*args, **kwargs))
    __swig_destroy__ = _simuPOP_laop.delete_sb_MutSpaceSelector
sb_MutSpaceSelector_swigregister = _simuPOP_laop.sb_MutSpaceSelector_swigregister
sb_MutSpaceSelector_swigregister(sb_MutSpaceSelector)

class sb_MutSpaceMutator(BaseOperator):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _simuPOP_laop.sb_MutSpaceMutator_swiginit(self,_simuPOP_laop.new_sb_MutSpaceMutator(*args, **kwargs))
    __swig_destroy__ = _simuPOP_laop.delete_sb_MutSpaceMutator
sb_MutSpaceMutator_swigregister = _simuPOP_laop.sb_MutSpaceMutator_swigregister
sb_MutSpaceMutator_swigregister(sb_MutSpaceMutator)

class sb_MutSpaceRecombinator(GenoTransmitter):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _simuPOP_laop.sb_MutSpaceRecombinator_swiginit(self,_simuPOP_laop.new_sb_MutSpaceRecombinator(*args, **kwargs))
    __swig_destroy__ = _simuPOP_laop.delete_sb_MutSpaceRecombinator
sb_MutSpaceRecombinator_swigregister = _simuPOP_laop.sb_MutSpaceRecombinator_swigregister
sb_MutSpaceRecombinator_swigregister(sb_MutSpaceRecombinator)
