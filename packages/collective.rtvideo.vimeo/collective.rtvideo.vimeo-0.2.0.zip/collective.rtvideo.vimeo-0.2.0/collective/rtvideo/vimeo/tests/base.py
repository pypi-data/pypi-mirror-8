...
def setup_product():
    ...
    import collective.rtvideo.vimeo
    import redturtle.video
    zcml.load_config('configure.zcml', redturtle.video)
    zcml.load_config('configure.zcml', collective.rtvideo.vimeo)
    ...
    ztc.installPackage('collective.rtvideo.vimeo')
...
setup_product()
ptc.setupPloneSite(products=['redturtle.video', 'collective.rtvideo.vimeo'])
