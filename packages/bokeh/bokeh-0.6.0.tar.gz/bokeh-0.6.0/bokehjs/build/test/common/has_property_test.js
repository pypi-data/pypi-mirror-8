(function() {
  require(["underscore", "backbone", "common/base", "common/continuum_view", "common/has_properties", "../test/common/test_object"], function(_, Backbone, base, ContinuumView, HasProperties, test_object) {
    var testobjects;
