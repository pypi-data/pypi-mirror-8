...
def setup_product():
    ...
    import rer.structured_content
    zcml.load_config('configure.zcml', rer.structured_content)
    ...
    ztc.installPackage('rer.structured_content')
...
setup_product()
ptc.setupPloneSite(products=['rer.structured_content'])
