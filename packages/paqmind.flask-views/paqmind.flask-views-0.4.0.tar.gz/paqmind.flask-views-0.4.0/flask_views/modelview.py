...
class ModelView(View):
    ...
    def _index(self, index):
        ...
        if redirect:
            return redirect
        data = self.do_index(paginator, index)
    ...
    def do_filter(self, form, index):
        ...
        self.force_filters(index, filters)
    ...
    def do_index(self, paginator, index):
        raise Exception('Define `{}.do_index` method'.format(self.__class__.__name__))
