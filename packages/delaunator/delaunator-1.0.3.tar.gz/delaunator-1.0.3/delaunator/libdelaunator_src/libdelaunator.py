...
class Triangulation(_object):
    ...
    def coordinateCorrection(self, *args): return _libdelaunator.Triangulation_coordinateCorrection(self, *args)
    ...
    def have(self, *args): return _libdelaunator.Triangulation_have(self, *args)
