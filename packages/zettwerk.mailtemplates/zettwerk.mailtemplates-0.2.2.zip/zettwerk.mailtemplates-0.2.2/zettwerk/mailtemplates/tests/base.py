...
def setup_product():
    ...
    import zettwerk.mailtemplates
    zcml.load_config('configure.zcml', zettwerk.mailtemplates)
    ...
    ztc.installPackage('zettwerk.mailtemplates')
...
setup_product()
ptc.setupPloneSite(products=['zettwerk.mailtemplates'])
