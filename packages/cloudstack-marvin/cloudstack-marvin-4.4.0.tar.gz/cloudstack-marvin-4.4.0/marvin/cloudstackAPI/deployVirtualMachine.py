...
class deployVirtualMachineCmd (baseCmd):
    def __init__(self):
        ...
        self.projectid = None
        """Optional field to resize root disk on deploy. Only applies to template-based deployments. Analogous to details[0].rootdisksize, which takes precedence over this parameter if both are provided"""
