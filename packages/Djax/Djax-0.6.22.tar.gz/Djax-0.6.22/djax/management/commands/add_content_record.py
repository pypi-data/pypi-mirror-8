...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        make_option('--applabel',dest='app_label',help='The app label to which the local model belongs.'),
        make_option('--localmodel',dest='local_mod',help='The name of the local model'),
        make_option('--localid',dest='local_id',help='The id of the local model'),
    )
