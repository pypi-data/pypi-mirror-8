...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.recorder'
        db.add_column(u'liver_record', 'recorder',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liver.Recorder'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.recorder'
        db.delete_column(u'liver_record', 'recorder_id')
    ...
    models = {
        ...
        u'liver.recorder': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'e370b3f2-5781-11e4-83cd-8331ab616f06'", 'max_length': '5000'})
        },
        u'liver.recordjob': {
