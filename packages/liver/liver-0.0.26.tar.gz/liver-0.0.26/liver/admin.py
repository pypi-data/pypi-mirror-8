...
class RecordingJobAdmin(admin.ModelAdmin):
    ...
    def wait(self, request, queryset):
        queryset.update("waiting")
        self.message_user(request, _("Set waiting"))

    def cancel(self, request, queryset):
        queryset.update("cancelled")
        self.message_user(request, _("Set cancelled"))

    def success(self, request, queryset):
        queryset.update("successful")
        self.message_user(request, _("Set successful"))
