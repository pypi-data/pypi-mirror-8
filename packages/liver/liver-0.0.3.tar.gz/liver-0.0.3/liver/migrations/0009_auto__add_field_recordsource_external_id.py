...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecordSource.external_id'
        db.add_column(u'liver_recordsource', 'external_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecordSource.external_id'
        db.delete_column(u'liver_recordsource', 'external_id')
    ...
    models = {
        ...
        u'liver.recorder': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'6ed435aa-557e-11e4-83cd-13d851cfc35b'", 'max_length': '5000'})
        },
        u'liver.recordjob': {
