...
output_root = os.path.join(data_root, "Testing", "output", "SimpleRuleTaggerApp")
...
the_tagger = Taggers.SimpleRuleTagger(include_untagged_tag_maps=False)
