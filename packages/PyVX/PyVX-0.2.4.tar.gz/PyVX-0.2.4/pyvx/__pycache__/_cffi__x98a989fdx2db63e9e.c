...
static PyObject *
_cffi_f_vlcplay_create(PyObject *self, PyObject *arg0)
{
  char * x0;
  Py_ssize_t datasize;
  struct vlcplay * result;
...
static PyObject *
_cffi_f_vlcplay_next(PyObject *self, PyObject *args)
{
  struct vlcplay * x0;
  unsigned char * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_ParseTuple(args, "OO:vlcplay_next", &arg0, &arg1))
    return NULL;
...
static PyObject *
_cffi_f_vlcplay_release(PyObject *self, PyObject *arg0)
{
  struct vlcplay * x0;
  Py_ssize_t datasize;
...
static void _cffi_check_struct_vlcplay(struct vlcplay *p)
{
...
static PyObject *
_cffi_layout_struct_vlcplay(PyObject *self, PyObject *noarg)
{
  struct _cffi_aligncheck { char x; struct vlcplay y; };
  static Py_ssize_t nums[] = {
    sizeof(struct vlcplay),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct vlcplay, width),
    sizeof(((struct vlcplay *)0)->width),
    offsetof(struct vlcplay, height),
    sizeof(((struct vlcplay *)0)->height),
    -1
  };
  return _cffi_get_struct_layout(nums);
  /* the next line is not executed, but compiled */
  _cffi_check_struct_vlcplay(0);
}
...
static PyMethodDef _cffi_methods[] = {
  {"vlcplay_create", _cffi_f_vlcplay_create, METH_O, NULL},
  {"vlcplay_next", _cffi_f_vlcplay_next, METH_VARARGS, NULL},
  {"vlcplay_release", _cffi_f_vlcplay_release, METH_O, NULL},
  {"_cffi_layout_struct_vlcplay", _cffi_layout_struct_vlcplay, METH_NOARGS, NULL},
...
PyMODINIT_FUNC
PyInit__cffi__x98a989fdx2db63e9e(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x98a989fdx2db63e9e(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x98a989fdx2db63e9e", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
