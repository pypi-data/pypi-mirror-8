...
struct cinc_integer : public base_cinc_int
{
    ...
    static PyObject* add(cinc_integer<T>* self, PyObject* other);
    static PyObject* subtract(cinc_integer<T>* self, PyObject* other);

    static PyObject* multiply(cinc_integer<T>* self, PyObject* other);
    static PyObject* divide(cinc_integer<T>* self, PyObject* other);
    static PyObject* remainder(cinc_integer<T>* self, PyObject* other);
    static PyObject* divmod(cinc_integer<T>* self, PyObject* other);
    static PyObject* power(cinc_integer<T>* self, PyObject* other, PyObject* mod);
    ...
    static PyObject* lshift(cinc_integer<T>* self, PyObject* other);
    static PyObject* rshift(cinc_integer<T>* self, PyObject* other);

    static PyObject* bitwise_and(cinc_integer<T>* self, PyObject* other);
    static PyObject* bitwise_or(cinc_integer<T>* self, PyObject* other);
    static PyObject* bitwise_xor(cinc_integer<T>* self, PyObject* other);
 ...
 */
template<typename T>
PyObject* cinc_integer<T>::add(cinc_integer<T>* self, PyObject* other)
{
    T othervalue;
    cast_cinc(other, othervalue);
...
template<typename T>
PyObject* cinc_integer<T>::subtract(cinc_integer<T>* self, PyObject* other)
{
    T othervalue;
    cast_cinc(other, othervalue);
    return cinc_integer<T>::create_object(Py_TYPE(self),
 ...
 */
template<typename T>
PyObject* cinc_integer<T>::multiply(cinc_integer<T>* self, PyObject* other)
{
    T othervalue;
    cast_cinc(other, othervalue);
    return cinc_integer<T>::create_object(Py_TYPE(self),
...
template<typename T>
PyObject* cinc_integer<T>::divide(cinc_integer<T>* self, PyObject* other)
{
    T othervalue;
    cast_cinc(other, othervalue);
    if(othervalue == 0)
...
template<typename T>
PyObject* cinc_integer<T>::remainder(cinc_integer<T>* self, PyObject* other)
{
    T othervalue;
    cast_cinc(other, othervalue);
    if(othervalue == 0)
    ...
    return cinc_integer<T>::create_object(Py_TYPE(self), self->value % othervalue);
}

template<typename T>
PyObject* cinc_integer<T>::divmod(cinc_integer<T>* self, PyObject* other)
{
    T othervalue;
    cast_cinc(other, othervalue);
    if(othervalue == 0)
    ...
    T quot = self->value / othervalue;
    T remain = self->value % othervalue;

    PyObject* pyquot = cinc_integer<T>::create_object(Py_TYPE(self), quot);
    if(pyquot == NULL)
        return NULL;
    PyObject* pyremain = cinc_integer<T>::create_object(Py_TYPE(self), remain);
    if(pyremain == NULL)
    {
        Py_DECREF(pyquot);
        return NULL;
 ...
 */
template<typename T>
PyObject* cinc_integer<T>::power(cinc_integer<T>* self, PyObject* other, PyObject* mod)
{
    T othervalue, modvalue = 0;
    cast_cinc(other, othervalue);
    if(mod != Py_None)
    {
        if(othervalue < 0)
 ...
 */
template<typename T>
PyObject* cinc_integer<T>::lshift(cinc_integer<T>* self, PyObject* other)
{
    unsigned char shift;
    cast_cinc_pyint(other, shift)
    return cinc_integer<T>::create_object(Py_TYPE(self),
                                          self->value << shift);
}

template<typename T>
PyObject* cinc_integer<T>::rshift(cinc_integer<T>* self, PyObject* other)
{
    unsigned char shift;
    cast_cinc_pyint(other, shift)
    return cinc_integer<T>::create_object(Py_TYPE(self),
 ...
 */
template<typename T>
PyObject* cinc_integer<T>::bitwise_and(cinc_integer<T>* self, PyObject* other)
{
    T othervalue;
    cast_cinc(other, othervalue);
    return cinc_integer<T>::create_object(Py_TYPE(self),
...
template<typename T>
PyObject* cinc_integer<T>::bitwise_or(cinc_integer<T>* self, PyObject* other)
{
    T othervalue;
    cast_cinc(other, othervalue);
    return cinc_integer<T>::create_object(Py_TYPE(self),
...
template<typename T>
PyObject* cinc_integer<T>::bitwise_xor(cinc_integer<T>* self, PyObject* other)
{
    T othervalue;
    cast_cinc(other, othervalue);
    return cinc_integer<T>::create_object(Py_TYPE(self),
...
PyNumberMethods type ## _number_methods = { \
    (binaryfunc)integer::add, /* add */ \
    (binaryfunc)integer::subtract, /* subtract */ \
    (binaryfunc)integer::multiply, /* multiply */ \
    (binaryfunc)integer::remainder, /* remainder */ \
    (binaryfunc)integer::divmod, /* divmod */ \
    (ternaryfunc)integer::power, /* power */ \
    ...
    (binaryfunc)integer::lshift, /* left shift */ \
    (binaryfunc)integer::rshift, /* right shift */ \
    (binaryfunc)integer::bitwise_and, /* and */ \
    (binaryfunc)integer::bitwise_xor, /* xor */ \
    (binaryfunc)integer::bitwise_or, /* or */ \
    ...
    0, /* in place xor */ \
    0, /* in place or */ \
    (binaryfunc)integer::divide, /* floor divide */ \
    0, /* true divide */ \
}; \
