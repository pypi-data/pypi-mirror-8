...
Download-URL: https://github.com/ankostis/wltp/tarball/v0.0.9-alpha.3
Description: #############################
        *wltp* gear-shifts calculator
        ...
        .. Attention:: This project is still in *alpha* stage.  Its results are not
            ...
            * In the doc(``CHANGES``).
            * Presented in the diagrams of the `metrics`_ section.
        ...
        * `Canopy <https://www.enthought.com/products/canopy/>`_,
        ...
        Install
        =======
        Current x.x.x runs on Python-2.7+ and Python-3.3+ but 3.3+ is the preferred one, 
        ...
        *Mean Engine-speed* vs *Gears*
        ...
        ..  pyplots/gears_n_arrows_class_1.py
        ..  pyplots/gears_n_arrows_class_2.py
        ..  pyplots/gears_n_arrows_class_3.py
