...
$python setup.py install  --install-scripts=mypath OR
$python setup.py install --user --install-scripts=mypath 

If you have libebf_multi-x.x.x then libebf_python_x.x.x.tar.gz  can be found in 
libebf_multi-x.x.x/extra . The --install_scripts option if specified 
...
not be in your search path. 

To run the test suite just do (from within folder libebf_python_x.x.x)
::
