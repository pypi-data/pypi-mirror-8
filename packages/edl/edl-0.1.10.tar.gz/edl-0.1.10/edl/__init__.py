...
class List(object):
    ...
    def get_start(self):
        """Returns the start timecode of the EDL.
        """
        start_tc = None
        for e in self.events:
            if start_tc is None:
    ...
    def get_end(self):
        """Returns the end timecode of the EDL.
        """
        end_tc = None
        for e in self.events:
            if end_tc is None:
    ...
    def get_length(self):
        """Returns length of EDL in frames. 
        """
        return self.get_end().frames - self.get_start().frames

    def append(self, evt):
        """Append EDL Event to the events list.
        """
...
class Matcher(object):
    ...
    """A base class for creating EDL line matchers.
    """
    ...
    def matches(self, line):
        """Returns boolean based on if the EDL line matches the regular 
        expression it is initialised with.
        """
