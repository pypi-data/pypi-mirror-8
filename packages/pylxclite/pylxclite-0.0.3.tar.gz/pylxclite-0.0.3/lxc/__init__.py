...
__all__ = ['checkconfig', 'create', 'clone', 'destroy', 'exists', 'freeze', 'info', 'ls', 'running', 'stopped', 'start', 'status', 'stop', 'subprocess', 'unfreeze']
...
def stopped():
    '''
    returns a list of the currently stopped containers
    return {'STOPPED': ['360','gmo']}
    '''
    d = {}
    l = []
    for name in ls():
