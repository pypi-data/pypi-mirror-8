...
SYSTEM_NAME = "Big upload test"

#An informative description for this system:
SYSTEM_DESCRIPTION = "Big upload test"
...
USERS = { 'proycon': pwhash('proycon',SYSTEM_ID, 'test') }
...
PROFILES = [
    Profile(
        InputTemplate('audioinput',WaveAudioFormat,"Input text document",
            extension='.wav',
            multi=True,
            acceptarchive=True,
        ),
...
#
COMMAND = sys.path[0] + "/wrappers/test4.py $DATAFILE"
