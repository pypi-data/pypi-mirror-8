...
"""Setup script for packaging mathjspy.
...
__url__ = 'http://mathjspy.readthedocs.org'
__downloadUrl__ = "http://bitbucket.org/amorris/mathjspy/downloads"


def get_version():
    f = open(os.path.join(here, 'mathjspy', '__init__.py'))
    version_file = f.read()
    f.close()
...
setup(name='mathjspy',
      ...
      # metadata
      version=get_version(),
      description="A Python library evaluate mathematical expressions in the same manner as MathJS.",
