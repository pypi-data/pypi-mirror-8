...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TabUiList'
        db.create_table(u'cmsplugin_tab_ui_tabuilist', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('custom_classes', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'cmsplugin_tab_ui', ['TabUiList'])

        # Adding model 'TabUi'
        db.create_table(u'cmsplugin_tab_ui_tabui', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'cmsplugin_tab_ui', ['TabUi'])


    def backwards(self, orm):
        # Deleting model 'TabUiList'
        db.delete_table(u'cmsplugin_tab_ui_tabuilist')

        # Deleting model 'TabUi'
        db.delete_table(u'cmsplugin_tab_ui_tabui')
