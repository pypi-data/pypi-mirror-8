...
class GoogleAnalyticsTextProvider(TextProvider):
    def __init__(self, ga, data, metrics, legend=None, legend_metrics=None, start=None, end=None):
        self.data = data
        self.legend = legend
    ...
    def get_data(self):
        ...
        if self.data:
            return self.data.format(**metrics)
        else:
            return ""
    ...
    def get_legend(self):
        ...
        if self.legend:
            return self.legend.format(**metrics)
        else:
            return ""


class GoogleAnalyticsDonutProvider(DonutProvider):
    def __init__(self, ga, metric, dimension, start=None, end=None):
        self.ga = ga
        self.end = end
        self.start = start
        self.metric = metric
