...
# FIXME: Move to compat or managers.py
...
#class AbstractRasterModel(models.Model):
class AbstractRasterStore(models.Model):
    ...
    # Allow custom projection, would like to avoid mucking with
    # the spatial_ref_sys table.
    # sref or srs?
    srs = models.CharField(_('spatial reference system'), max_length=256) # 128 not long enough >206
    ...
    def __unicode__(self):
        #return os.path.basename(self.gdal.path)
