...
class SmartProxyRecorder(object):
    ...
    def record_request(self, request):
        ...
        recorded_request, created = SmartProxyRequest.objects.get_or_create(
    ...
    def record_response(self, recorded_request, response):
        ...
        SmartProxyResponse.objects.create(request=recorded_request,
    ...
    def playback(self, request):
        ...
        """
        try:
            matching_request = SmartProxyRequest.objects.filter(method=request.method,
            ...
            raise SmartProxyRequestNotRecorded('The request made has not been ' \
                    'recorded yet. Please run smart_proxy in "record" mode ' \
                    'first.')
