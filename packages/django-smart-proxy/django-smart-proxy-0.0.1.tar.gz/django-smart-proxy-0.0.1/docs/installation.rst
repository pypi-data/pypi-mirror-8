...
Django Smart Proxy is compatible with Python 2.5.x and Python 2.6.x. It was
...
Django Smart Proxy is `available on the Python Package Index <http://pypi.python.org/pypi/django-http-proxy>`_.
...
To use Django Smart Proxy, you create an entry in your ``urls.py`` that forwards
