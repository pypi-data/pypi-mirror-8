...
class turbConfigFrame(ConfigFrame):
    ...
    def set_aliases(self,):
        #self.cho_turbmodel={}
        self.cho_iec_turbclass_windtype=cho_windtype_turbclass(self.cho_iecwindtype,self.cho_iecclass)
    ...
    def onKHConfig(self,event):
        try:
            ...
            self.frm_ConfigProf=KHBillowsConfigFrame(self,wx.ID_ANY,'Kelvin-Helmholtz Billows - Settings')
