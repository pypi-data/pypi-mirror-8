...
### IHCMEASURE ################################################################
###############################################################################
_pvs.tag_object_of(('*', 'generates', 'IHCMeasure'), 'attributes')
_pvs.tag_subject_of(('IHCResult', 'related_measure', 'IHCMeasure'), 'attributes')
_pvs.tag_object_of(('IHCResult', 'related_measure', 'IHCMeasure'), 'relations')
_pvdc.tag_object_of(('IHCResult', 'related_measure', 'IHCMeasure'), {'vid': 'table'})
...
_pvs.tag_object_of(('*', 'related_measure', 'GenomicMeasure'), 'hidden')
_pvdc.display_rset('GenomicMeasure', 'relations', {'order': 2,
                                                   'vid': 'genmeas-table-view',
                                                   'rql': 'Any M WHERE M is Mutation, '
                                                   'M related_measure X'})
_pvdc.display_rset('GenomicMeasure', 'relations', {'order': 2,
                                                   'vid': 'genmeas-table-view',
                                                   'rql': 'Any M WHERE M is CghResult, '
                                                   'M related_measure X'})
...
_pvs.tag_object_of(('Gene', 'chromosomes', 'Chromosome'), 'relations')
_pvdc.tag_object_of(('Gene', 'chromosomes', 'Chromosome'),
                     {'vid': 'list', 'label': _('Genes')})
# CGH results
...
_pvdc.tag_object_of(('Diagnostic', 'diagnosed_disease', 'Disease'), {'vid': 'list'})
...
_pvdc.tag_object_of(('Diagnostic', 'diagnostic_location', 'BodyLocation'), {'vid': 'list'})
...
_pvdc.display_rset('Biopsy', 'relations', {'rql': ('Any D WHERE D is TechnicalAnalysis, '
                                                   'D analysis_of_sample X, NOT D performed_in_therapy T'),
