                    ...
                    if on_row in range_rows:                      
                        ...
                        for exclude in exclude_rows:
                            if on_row in exclude: 
                                mdx+='-'+dimensiones[on_row][:position]+'&['+ exclude[on_row]+']'
                        if filtrar_dim:
                            mdx+= '&['+part_filter[on_row][0]+']'
                            if len(part_filter[on_row])>1:
                                for j in range(1,len(part_filter[on_row])):
                                    mdx+= dimensiones[on_row]+'&['+part_filter[on_row][j]+']'
