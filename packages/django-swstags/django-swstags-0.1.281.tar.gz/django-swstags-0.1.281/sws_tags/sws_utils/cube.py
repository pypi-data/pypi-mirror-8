...
def requestCube(ip_connect,name_bbdd,name_cube,col_cube,med_cube,request_data,ifDate,dimension_filters,database_cube_dict,total_data = False,where_tupla=('Date','Id','Id'),request_date_previous = False,complete_name=False,format_cube=False,n_c=[],ip_memcache="127.0.0.1:112",time_zone="",redis=""):
    ...
    col_cube = quitarDuplicados(col_cube)
    # print '****'*100
    # print part_order
    mdx=mdx_class.mdx(cube,part_rows=col_cube,exclude_rows=exclude_rows,part_columns=med_cube,part_from=name_cube,part_where=where,part_order=part_order,part_filter=part_filter) #ASC or DESC  ('measure','calls')
    # print ''
    # print ''
    # print ''
    # print ''
    # print '1111111111111'*100
    # print 'MDX GRID--->',mdx
    # print ''
    # print ''
    ...
    if data_order:
        # print 'data order in colcube ',(data_order in col_cube)
        if data_order in col_cube:
            # print 'asc in sord ',('ASC' in sord)
            if 'ASC' in sord:
                json_data= ujson.loads(json_data)
