...
def setup_product():
    ...
    import Products.mediaLink
    zcml.load_config('configure.zcml', Products.mediaLink)
    ...
    ztc.installPackage('Products.mediaLink')
...
setup_product()
ptc.setupPloneSite(products=['Products.mediaLink'])
