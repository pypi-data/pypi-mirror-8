# -*- coding: utf-8 -*-
# iwwb.eventlist documentation build configuration file, created by
...
htmlhelp_basename = 'iwwbeventlistdoc'
...
latex_documents = [
  ('index',
   'iwwbeventlist.tex',
  u'iwwb.eventlist Documentation',
  u'', 'manual'
  ),
]
