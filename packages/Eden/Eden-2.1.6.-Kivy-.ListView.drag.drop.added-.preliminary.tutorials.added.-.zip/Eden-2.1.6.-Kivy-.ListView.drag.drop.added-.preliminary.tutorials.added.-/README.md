...
Kivy version:
	ListViews with sortable columns, drag and drop and column resizing added.
	Some Node and View persistence added.
	Comments and usage directions added to preliminary tutorials.
