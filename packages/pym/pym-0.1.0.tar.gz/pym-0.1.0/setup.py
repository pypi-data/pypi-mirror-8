...
setup(
    ...
    download_url='https://bitbucket.org/mbondfusion/pym/get/v0.1.0.tar.gz',
...
The pymenu module is a console based menu system for Python 3.x+. It outputs provided menu choices with pagination depending on your current terminal size.
