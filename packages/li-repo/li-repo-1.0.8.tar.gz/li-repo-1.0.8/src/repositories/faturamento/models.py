...
class Fatura(models.Model):
    ...
    valor_pago = models.DecimalField(db_column="fatura_valor_pago", decimal_places=2, max_digits=12)
...
class FaturaItem(models.Model):
    ...
    referencia_situacao_principal = models.CharField(db_column="fatura_item_referencia_situacao_principal")
    referencia_situacao_complementar = models.CharField(db_column="fatura_item_referencia_situacao_complementar")
