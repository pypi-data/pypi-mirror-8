...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proxy.elapsed_time'
        db.add_column('proxylist_proxy', 'elapsed_time',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proxy.elapsed_time'
        db.delete_column('proxylist_proxy', 'elapsed_time')
