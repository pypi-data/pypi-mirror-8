...
def setup_product():
    ...
    import medialog.simpleslider
    zcml.load_config('configure.zcml', medialog.simpleslider)
    ...
    ztc.installPackage('medialog.simpleslider')
...
setup_product()
ptc.setupPloneSite(products=['medialog.simpleslider'])
