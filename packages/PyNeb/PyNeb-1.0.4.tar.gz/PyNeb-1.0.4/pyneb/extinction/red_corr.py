...
class RedCorr(object):
    ...
    def _CCM89_oD94(self, wave):
        """
        Galactic extinction law based on Cardelli et al 1989, modified by O'Donnel 1994
...
#    def _F99_like_IDL(self, wave):
    ...
    def _MCC99_FM90_LMC(self, wave):
        """
        This method returns the UV extinction curve proposed for the LMC 
        by Misselt et al 1989 based on the 1990 variant of the Fitzpatrick & Massa law

        Misselt, Clayton & Gordon 1989 , ApJ, 515, 128 
        ...
        """
        if (wave > 3125.): # The cutoff is taken from Fig 3 of MCC99. Couldn't find the number anywhere.
            pn.log_.warn('MCC89 law only defined for lambda < 3125A', calling=self.calling)
            return None
        x0 = 4.596  
        gamma = 0.91
        c1 = -1.28
