...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queue.allow_group_users'
        db.add_column(u'helpdesk_queue', 'allow_group_users',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queue.allow_group_users'
        db.delete_column(u'helpdesk_queue', 'allow_group_users')
    ...
    models = {
        ...
        u'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'helpdesk.queue': {
            ...
            'allow_group_users': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'helpdesk_queues'", 'null': 'True', 'to': u"orm['auth.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locale': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
