...
def setup_product():
    ...
    import monet.calendar.event
    zcml.load_config('configure.zcml', monet.calendar.event)
    ...
    ztc.installPackage('monet.calendar.event')
...
setup_product()
ptc.setupPloneSite(products=['monet.calendar.event'])
