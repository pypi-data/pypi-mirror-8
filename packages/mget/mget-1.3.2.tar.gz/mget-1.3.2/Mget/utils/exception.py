...
class ExtractorError(Exception):
	def __init__(self, msg, excepted=False, cause=None):
		...
		if not excepted:
			msg = msg + " please report this issue to r4v0n3@gmail.com.\
				 Be sure to call mget with the --verbose and include its complete \
				 output. Make sure you are using the latest version."
