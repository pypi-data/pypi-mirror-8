...
#	down.add_argument('-f', dest='v_format', metavar='FORMAT', type=int, help="video format code for youtube: \"-f 18\" By default, MGet will pick the best quality.")
	...
	work.add_argument('--manga-page', dest='manga_page', metavar='PAGE_NUM', type=int, default=1, help="Download Page from chapter in ${manga} from mangafox.")
...
#	'v_format'	: opts.v_format,
	...
	for url in urls:
		infos['cur_download'] += infos.get("manga-page") or 1
