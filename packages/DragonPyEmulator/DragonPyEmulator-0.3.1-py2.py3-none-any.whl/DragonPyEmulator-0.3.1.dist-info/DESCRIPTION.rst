...
* `http://archive.worldofdragon.org/archive/index.php?dir=Roms/Dragon/ <http://archive.worldofdragon.org/archive/index.php?dir=Roms/Dragon/>`_
...
`Travis CI Status <https://travis-ci.org/jedie/DragonPy>`_: |DragonPy build status on travis-ci.org|

.. |DragonPy build status on travis-ci.org| image:: https://secure.travis-ci.org/jedie/DragonPy.svg?branch=master

* `https://travis-ci.org/jedie/DragonPy <https://travis-ci.org/jedie/DragonPy>`_
...
* Grant Searle's Multicomp FPGA project:
    ...
    * Homepage: `http://searle.hostei.com/grant/Multicomp/ <http://searle.hostei.com/grant/Multicomp/>`_
...
* Grant Searle's Simple 6809 design:
    ...
    * Homepage: `http://searle.hostei.com/grant/6809/Simple6809.html <http://searle.hostei.com/grant/6809/Simple6809.html>`_
