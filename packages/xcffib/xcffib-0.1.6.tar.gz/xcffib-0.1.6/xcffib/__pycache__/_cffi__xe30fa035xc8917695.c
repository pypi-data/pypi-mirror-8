...
static PyMethodDef _cffi_methods[] = {
  ...
  {"_cffi_layout_struct_xcb_render_directformat_t", _cffi_layout_struct_xcb_render_directformat_t, METH_NOARGS},
  {"_cffi_layout_struct_xcb_render_pictforminfo_t", _cffi_layout_struct_xcb_render_pictforminfo_t, METH_NOARGS},
  {"_cffi_layout_struct_xcb_screen_t", _cffi_layout_struct_xcb_screen_t, METH_NOARGS},
...
PyMODINIT_FUNC
init_cffi__xe30fa035xc8917695(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xe30fa035xc8917695", _cffi_methods);
  if (lib == NULL || 0 < 0)
    return;
  _cffi_init();
  return;
