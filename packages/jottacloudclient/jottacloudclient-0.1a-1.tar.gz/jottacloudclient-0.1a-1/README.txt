...
The program expects to find ``JOTTACLOUD_USERNAME`` AND
``JOTTACLOUD_PASSWORD`` as variables in the running environment. So you
might want to do
...
Send pull requests to https://gitorious.org/jottafs/jottabox/ or patches
to havard@gulldahl.no
