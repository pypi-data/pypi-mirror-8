...
# Generated 2012-06-30 20:34:07.153247 by PyXB version 1.1.4
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    __mechanism = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mechanism'), 'mechanism', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_CTD_ANON_mechanism', STD_ANON, required=True)
...
class RestrictedLengthType (LengthType):
    ...
    # Attribute min uses Python identifier min
    __min = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min'), 'min', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_LengthType_min', STD_ANON_, required=True)
