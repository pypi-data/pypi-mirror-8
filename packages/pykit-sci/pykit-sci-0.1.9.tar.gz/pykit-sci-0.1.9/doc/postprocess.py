...
def process_tex(lines):
    ...
    for line in lines:
        ...
        if (line.startswith(r'\section{pksci.')
            or line.startswith(r'\subsection{pksci.')
            or line.startswith(r'\subsubsection{pksci.')
            or line.startswith(r'\paragraph{pksci.')
            or line.startswith(r'\subparagraph{pksci.')
            ):
            pass # skip!
        else:
