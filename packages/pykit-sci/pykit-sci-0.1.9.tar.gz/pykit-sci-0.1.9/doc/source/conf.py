...
#
# pykit-sci documentation build configuration file, created by
...
import pksci
version = re.sub(r'\.dev-.*$', r'.dev', pksci.__version__)
release = pksci.__version__

print("pykit-sci (VERSION {})".format(version))
...
htmlhelp_basename = 'pykit-sci-doc'
...
# [howto/manual]).
latex_documents = [('index', 'pykit-sci-ref.tex',
                    'pykit-sci Reference Guide',
...
man_pages = [
    ('index', 'pykit-sci', u'pykit-sci Documentation',
     [u'Andrew Merrill'], 1)
]
...
texinfo_documents = [('index', 'pykit-sci',
                      u'pykit-sci Documentation',
                      u'Andrew Merrill', 'pykit-sci',
                      'python toolkit',
                      'Miscellaneous')]
...
intersphinx_mapping = {
    ...
    'tasr': ('http://nprl.geekspin.net/tasr/doc', None),
}
...
def linkcode_resolve(domain, info):
    ...
    fn = relpath(fn, start=dirname(pksci.__file__))

    if 'dev' in pksci.__version__:
        return("https://github.com/androomerrill/pykit-sci/blob/" +
               "dev/pksci/{}{}".format(fn, linespec))
    else:
        return("https://github.com/androomerrill/pykit-sci/blob/" +
               "v{}/pksci/{}{}".format(pksci.__version__, fn, linespec))
