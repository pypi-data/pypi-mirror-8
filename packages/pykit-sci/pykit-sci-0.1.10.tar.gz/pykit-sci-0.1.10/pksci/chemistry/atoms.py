...
"""
===================================================================
Abstract representation of Atoms (:mod:`pksci.chemistry.atoms`)
===================================================================

.. currentmodule:: pksci.chemistry.atoms
...
from ..tools.refdata import dimensions
...
class Atoms(MutableSequence):
    ...
    @property
    def r(self):
        """Alias for :py:meth:`~pksci.chemistry.Atoms.CM`"""
        return self.CM
