...
project.
For the time being, I (Jehan) took up the maintainance, so please refer to this new website_ as being official, and
...
It works on Python 2.5 or above (works on Python 3 too).
