...
class ClientId(object):
  ...
  they can book keep and_ optionally reject unknown clients.
...
class RequestHeader(object):
  """
  RequestHeader defines headers for_ the request. These carry the span data, and_
  a flag indicating whether the request is_ to be debugged.
...
class ResponseHeader(object):
  """
  The Response carries a reply header for_ tracing. These are
  empty unless the request is_ being debugged, in_ which case a
  transcript is_ copied.
...
class UpgradeReply(object):
  """
  This is_ the struct that a successful upgrade will reply with_.
  """
