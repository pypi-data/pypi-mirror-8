...
-  apis.live.net host hangs after PUT (file upload) requests for 60s and
   resets the connection, as described in
   `#30 <https://github.com/mk-fg/python-onedrive/issues/30>`__.
