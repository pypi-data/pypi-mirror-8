...
def sanitize(id):
    return illegals.sub('_', id).lower()


state_codes = {'01': 'AL', '02': 'AK', '03': 'AS', '04': 'AZ', '05': 'AR', '06': 'CA', '08': 'CO', '09': 'CT',
               ...
               '43': 'PR', '44': 'RI', '45': 'SC', '46': 'SD', '47': 'TN', '48': 'TX', '49': 'UT', '50': 'VT',
               '51': 'VA', '53': 'WA', '54': 'WV', '55': 'WI', '56': 'WY', '60': 'AS', '64': 'FM', '68': 'MH',
               '69': 'MP', '70': 'PW', '72': 'PR'}