...
class AVISO_fetch(object):
    ...
    def download_var(self, v, dataset, attr):
            ...
            for b1, b2 in zip(blocks[:-1], blocks[1:]):
                # Acho que tem um problema aqui, não deveria de ser blocks[-1]
            ...
            # !!ATENTION!! Need to check how scale_factor is being defined
            #   Seems like I do not set it up explicitly, but it's there.
            setattr(data, "add_offset", 0.)
