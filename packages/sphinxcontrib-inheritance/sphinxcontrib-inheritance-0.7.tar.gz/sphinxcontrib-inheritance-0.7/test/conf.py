# -*- coding: utf-8 -*-
#
# Inheritance Test documentation build configuration file, created by
...
htmlhelp_basename = 'InheritanceTestdoc'
...
latex_documents = [
  ('index', 'InheritanceTest.tex', u'Inheritance Test Documentation',
   u'NaN·tic', 'manual'),
]
...
man_pages = [
    ('index', 'inheritancetest', u'Inheritance Test Documentation',
     [u'NaN·tic'], 1)
]
