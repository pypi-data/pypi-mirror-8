...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accordion_presentation_presentationmodel', (
            ...
            ('short_description', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
        ...
        db.send_create_signal(u'accordion_presentation', ['PresentationModel'])
