...
static PyObject *
_cffi_f__free_field_string(PyObject *self, PyObject *arg0)
{
  char * * x0;
  Py_ssize_t datasize;
...
_cffi_f_fourd_bind_param(PyObject *self, PyObject *args)
{
  ...
  if (_cffi_to_c((char *)&x2, _cffi_type(4), arg2) < 0)
    return NULL;
...
static PyMethodDef _cffi_methods[] = {
  ...
  {"_free_field_string", _cffi_f__free_field_string, METH_O, NULL},
...
PyMODINIT_FUNC
PyInit__Py4d_cffi_582f2acfx8cd1bb04(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_Py4d_cffi_582f2acfx8cd1bb04(void)
{
  PyObject *lib;
  lib = Py_InitModule("_Py4d_cffi_582f2acfx8cd1bb04", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
