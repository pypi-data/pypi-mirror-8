...
from suds.bindings.binding import NotMappedToPort
...
class SoapClient:
    ...
    def invoke(self, args, kwargs):
        ...
        msg = binding.get_message_for_method(self.method, args, kwargs)
        timer.stop()
        metrics.log.debug(
    ...
    def send(self, msg):
        ...
        try:
            ...
            if retxml:
                ...
                except NotMappedToPort: # EWS returns 200 even if there is fault
                    raise TransportError('Internal Server Error', 500, reply.message)
    ...
    def failed(self, binding, error):
        ...
        try:
            reply = error.fp.read()
        except AttributeError: # If has no read() method so assume string
            reply = error.fp
        except TypeError: # fp=None
            reply = ''
