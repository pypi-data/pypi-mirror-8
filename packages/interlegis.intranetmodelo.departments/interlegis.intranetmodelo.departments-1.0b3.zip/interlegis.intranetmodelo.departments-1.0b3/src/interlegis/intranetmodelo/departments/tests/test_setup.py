...
from interlegis.intranetmodelo.departments.interfaces import IBrowserLayer
from interlegis.intranetmodelo.departments.testing import FUNCTIONAL_TESTING
...
class BaseTestCase(unittest.TestCase):
    ...
    profile = 'interlegis.intranetmodelo.departments:default'
...
class TestInstall(BaseTestCase):
    ...
    def test_static_resource_grokker(self):
        ...
        browser.open('%s/++resource++interlegis.intranetmodelo.departments' % portal_url)
