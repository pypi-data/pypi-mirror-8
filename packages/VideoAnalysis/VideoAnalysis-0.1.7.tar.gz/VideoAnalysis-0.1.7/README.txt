...
You may get a similar error for tornado, which you can also install
with pip. (Why these are not listed in PyPI as requirements for
ipython[notebook] I don't understand...)
