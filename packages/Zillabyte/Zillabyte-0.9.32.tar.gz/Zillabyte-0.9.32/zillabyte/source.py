...
#   app.source( matches = "dataset_name" )
# 
# #Custom source:
#   app.source( 
#     name = "name",                                   # optional
...
#   * The **"next_tuple_function"** must take in 2 arguments (the "controller" and the "tuple"), and should return nothing. This is where the tuples are actually emitted.
# EXAMPLE 
