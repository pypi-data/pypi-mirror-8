...
from component_sink import ComponentSink
...
class OperationHandler:
  ...
  def build_multilang_operation(self, op_type, *args):
    if op_type == "source":
    ...
    elif op_type == "component_source":
      self._node = ComponentSource(self._app)
    elif op_type == "component_sink":
      self._node = ComponentSink(self._app)
    else:
      raise "unknown type"
