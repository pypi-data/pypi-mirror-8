...
mediaShow.loadSlide = function (slideshow, slideNumber)
{
    ...
    $.getJSON(URL, function(data, textStatus, jqXHR) {
        ...
        if(slideshow.presentation)
        {
          descriptionDiv = '<div class="mediaShowDescription col-lg-1 col-md-1 col-sm-1 col-xs-1">'+$("<div />").html(data.description).text();+'</div>';
        }
        else
        {
	  var separator = " ";
	  ...
	  {
		descriptionDiv = $('<div class="mediaShowDescription col-lg-1 col-md-1 col-sm-1 col-xs-1">'+ data.description +'</div>');
	  }
          else
	  {
