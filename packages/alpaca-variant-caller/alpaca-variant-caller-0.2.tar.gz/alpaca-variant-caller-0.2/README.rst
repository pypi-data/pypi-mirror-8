...
ALPACA is a single nucleotide variant caller for next-generation sequencing reads
providing providing intuitive control over the false discovery rate with generic
...
=========== =======================================================================
30 Nov 2015 Release 0.2 of ALPACA. This initial release provides all functionality
