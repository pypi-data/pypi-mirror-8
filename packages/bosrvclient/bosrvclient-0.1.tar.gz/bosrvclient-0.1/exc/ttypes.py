...
class ServiceError(TException):
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'misc', None, None, ), # 2
  )

  def __init__(self, why=None, misc=None,):
    self.why = why
    self.misc = misc
  ...
  def write(self, oprot):
    ...
    if self.misc is not None:
      oprot.writeFieldBegin('misc', TType.STRING, 2)
...
class AuthError(TException):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'why', None, "invalid auth token", ), # 1
    (2, TType.STRING, 'misc', None, None, ), # 2
  )

  def __init__(self, why=thrift_spec[1][4], misc=None,):
    self.why = why
    self.misc = misc
...
class SQLError(TException):
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'misc', None, None, ), # 3
  )

  def __init__(self, code=None, why=None, misc=None,):
    self.code = code
    self.why = why
    self.misc = misc
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('SQLError')
...
class ASSOCError(TException):
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('ASSOCError')
    if self.code is not None:
      oprot.writeFieldBegin('code', TType.I32, 1)
      oprot.writeI32(self.code)
      oprot.writeFieldEnd()
