...
triggers_exist = '''
    select 1 from RDB$Triggers where RDB$Trigger_name = 'SIC_PUNTOS_PV_DOCTOSPVDET_BU' or RDB$Trigger_name= 'SIC_PUNTOS_PV_DOCTOSPV_BU'
    '''

procedure_delete_triggers = '''
...
exceptions_activate['EX_SIC_CLIENTE_SIN_SALDO'] = '''
    CREATE OR ALTER EXCEPTION EX_SIC_CLIENTE_SIN_SALDO 'El cliente no tiene suficiente saldo';
    '''
#####################
#                   #
# DETALLE DE VENTAS #
...
triggers_activate['SIC_PUNTOS_PV_DOCTOSPVDET_BU'] = '''
...
triggers_activate['SIC_PUNTOS_PV_DOCTOSPV_BU'] = '''
    ...
    if (feb=0)then
        ...
        BEGIN
            ...
            IF(cliente_tipo_tarjeta = 'N' AND NEW.dscto_importe >0 and cliente_aplicar_descuento_sin_tarjeta = 0 ) THEN
                EXCEPTION EX_SIC_CLIENTE_SIN_SALDO 'NO TIENES PERMITIDO APLICAR DESCUENTOS A ESTE CLIENTE';
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    EXCEPTION EX_SIC_CLIENTE_SIN_SALDO 'El cliente no tiene suficientes puntos, solo tiene('||documentos_total_puntos ||' en puntos.) No se agregara el descuento extra.';                    
                END
                ...
                BEGIN
                    ...
                    EXCEPTION EX_SIC_CLIENTE_SIN_SALDO 'El cliente no tiene suficientes Dinero Electronico, solo tiene('||documentos_total_dinero_elect||' en Dinero electronico.) No se agregara el descuento extra.';
                END
            END
        END
    END
