...
from .particles import MoleculeSTS, Molecule, Atom
...
def rec_rate_treanor_marrone_sts(T: float, model_data: np.ndarray, molecule: MoleculeSTS, atom1: Atom, atom2: Atom,
...
def rec_rate_rigid_sphere_sts(T: float, idata: np.ndarray, molecule: MoleculeSTS, atom1: Atom, atom2: Atom, i: int,
                              center_of_mass: bool=True, vl_dependent: bool=True) -> float:
    ...
    return raw_rec_rate_rigid_sphere_sts(T, idata[1], idata[0], molecule.Z_rot(T), molecule.mass, atom1.mass,
                                         atom2.mass, molecule.vibr[i], molecule.diss, center_of_mass, vl_dependent)
...
def rec_rate_treanor_marrone(T: float, model_data: np.ndarray, molecule: Molecule, atom1: Atom, atom2: Atom) -> float:
...
def rec_rate_rigid_sphere(T: float, T1: float, idata: np.ndarray, molecule: Molecule, atom1: Atom, atom2: Atom,
                          center_of_mass: bool=True, vl_dependent: bool=True) -> float:
