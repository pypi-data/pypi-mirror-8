...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EPN.cpn'
        db.alter_column(u'aps_bom_epn', 'cpn_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['aps_bom.IPN']))

        # Changing field 'EPN.ipn'
        db.alter_column(u'aps_bom_epn', 'ipn_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['aps_bom.IPN']))
        # Adding field 'CBOMItem.consign'
        db.add_column(u'aps_bom_cbomitem', 'consign',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EPN.cpn'
        db.alter_column(u'aps_bom_epn', 'cpn_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['aps_bom.IPN']))

        # Changing field 'EPN.ipn'
        db.alter_column(u'aps_bom_epn', 'ipn_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['aps_bom.IPN']))
        # Deleting field 'CBOMItem.consign'
        db.delete_column(u'aps_bom_cbomitem', 'consign')
