...
class Company(models.Model):
    ...
    :shipping_days: How many shipping days it needs to ship from or to this
      company
...
class IPN(models.Model):
    ...
    :shape: TODO
    :technology: What technology this IPN is.
    :product: What product this IPN belongs to.
...
class Product(models.Model):
    """
    Something, that is actually sold.

    :product_number: A unique string, that identifies the product
...
class Technology(models.Model):
    """
    Describes, what kind of product a certain IPN is.

    :identifier: A short string to identify the technology.
