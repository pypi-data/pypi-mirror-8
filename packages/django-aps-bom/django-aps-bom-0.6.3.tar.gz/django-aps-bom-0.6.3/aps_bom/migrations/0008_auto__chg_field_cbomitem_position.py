...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CBOMItem.position'
        db.alter_column(u'aps_bom_cbomitem', 'position', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):

        # Changing field 'CBOMItem.position'
        db.alter_column(u'aps_bom_cbomitem', 'position', self.gf('django.db.models.fields.CharField')(max_length=5))
