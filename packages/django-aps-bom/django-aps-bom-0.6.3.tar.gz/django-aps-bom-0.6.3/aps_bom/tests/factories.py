...
class AdditionalTextFactory(factory.DjangoModelFactory):
    ...
    FACTORY_FOR = models.AdditionalText
...
class PriceMarkerFactory(factory.DjangoModelFactory):
    ...
    FACTORY_FOR = models.PriceMarker
...
class ProductFactory(factory.DjangoModelFactory):
    """Factory for the ``Product`` model class."""
    FACTORY_FOR = models.Product

    product_number = factory.Sequence(lambda n: 'product_number {0}'.format(n))


class ShapeFactory(factory.DjangoModelFactory):
    """Factory for the ``Shape`` model."""
    FACTORY_FOR = models.Shape
...
class TechnologyFactory(factory.DjangoModelFactory):
    """Factory for the ``Technology`` model class."""
    FACTORY_FOR = models.Technology

    identifier = factory.Sequence(lambda n: '{0}'.format(n))


class UnitFactory(factory.DjangoModelFactory):
    """Factory for the ``Unit`` model."""
    FACTORY_FOR = models.Unit
