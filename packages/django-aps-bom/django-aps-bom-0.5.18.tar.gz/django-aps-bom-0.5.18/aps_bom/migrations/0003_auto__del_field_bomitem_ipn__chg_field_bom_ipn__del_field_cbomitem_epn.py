...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BOMItem.ipn'
        db.delete_column(u'aps_bom_bomitem', 'ipn_id')


        # Changing field 'BOM.ipn'
        db.alter_column(u'aps_bom_bom', 'ipn_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['aps_bom.IPN']))
        # Deleting field 'CBOMItem.epn'
        db.delete_column(u'aps_bom_cbomitem', 'epn')


    def backwards(self, orm):
        # Adding field 'BOMItem.ipn'
        db.add_column(u'aps_bom_bomitem', 'ipn',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='bomitems', to=orm['aps_bom.IPN']),
                      keep_default=False)


        # Changing field 'BOM.ipn'
        db.alter_column(u'aps_bom_bom', 'ipn_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['aps_bom.IPN']))
        # Adding field 'CBOMItem.epn'
        db.add_column(u'aps_bom_cbomitem', 'epn',
