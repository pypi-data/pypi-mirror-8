...
function program1(depth0,data) {
  ...
  data.buffer.push(escapeExpression((helper = helpers.ellipsis || (depth0 && depth0.ellipsis),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0,depth0],types:["ID","INTEGER"],data:data},helper ? helper.call(depth0, "env.workspace.cleanValues.name", 12, options) : helperMissing.call(depth0, "ellipsis", "env.workspace.cleanValues.name", 12, options))));
...
function program3(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, "auth.isAuthenticated", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\r\n        <a class=\"navbar-brand vlt-navbar-brand\" href=\"#\">\r\n            <img class=\"vlt-logo\" src=\"/static/vaultier/images/logo.png\"/>\r\n        </a>\r\n    </div>\r\n\r\n    ");
  stack1 = helpers['if'].call(depth0, "auth.isAuthenticated", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\r\n</nav>\r\n\r\n\r\n\r\n");
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<div class=\"clearfooter\"></div>\n<footer>\n    <div class=\"container-full\">\n        <div class=\"pull-left vlt-enterprise\">\n            <p>\n                <a href=\"http://www.vaultier.org/products/\" class=\"btn btn-default\" target=\"_blank\">\n                    Enterprise Edition pricing\n                </a>\n            </p>\n        </div>\n        <div class=\"pull-left vlt-feedback\">\n            <p>\n                <a href=\"http://vaultier.org/contact/\" class=\"btn btn-default\" target=\"_blank\">\n                    Feedback & Bug report\n                </a>\n            </p>\n        </div>\n        <div class=\"pull-right vlt-rclick\">\n            <a href=\"http://www.rclick.cz/\" target=\"_blank\">\n                created by <img height=\"35px\" src=\"/static/vaultier/images/rclick.png\">\n            </a></p>\n        </div>\n        <div class=\"pull-right vlt-version\">\n           Vaultier  ");
