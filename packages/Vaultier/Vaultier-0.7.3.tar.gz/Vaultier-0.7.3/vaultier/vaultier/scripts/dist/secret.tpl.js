...
function program3(depth0,data) {
  ...
  data.buffer.push("\r\n                </div>\r\n            </div>\r\n\r\n            ");
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "Vaultier.SecretIndexItemControlsView", {hash:{
    'class': ("vlt-secret-item-controls")
...
function program5(depth0,data) {
  ...
  data.buffer.push("<div class=\"vlt-secret-item-base vlt-secret-item-note\">\r\n    <div class=\"vlt-left-panel vlt-background-");
  data.buffer.push(escapeExpression(helpers.unbound.call(depth0, "view.controller.parentController.vault.color", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data})));
...
function program12(depth0,data) {
  ...
  data.buffer.push("<div class=\"vlt-secret-item-base vlt-secret-item-password\">\r\n    <div class=\"vlt-left-panel vlt-background-");
  data.buffer.push(escapeExpression(helpers.unbound.call(depth0, "view.controller.parentController.vault.color", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data})));
  data.buffer.push("\">\r\n        <div class=\"vlt-wrapper\">\r\n            <div class=\"vlt-icon\"></div>\r\n            <div class=\"vlt-type\">\r\n                Password\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"vlt-right-panel\">\r\n        ");
  stack1 = helpers['if'].call(depth0, "name", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program16(depth0,data) {
  ...
  data.buffer.push("<div class=\"vlt-secret-item-base vlt-secret-item-file\">\r\n    <div class=\"vlt-left-panel vlt-background-");
  data.buffer.push(escapeExpression(helpers.unbound.call(depth0, "view.controller.parentController.vault.color", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data})));
  data.buffer.push("\">\r\n        <div class=\"vlt-wrapper\">\r\n            <div class=\"vlt-icon\"></div>\r\n            <div class=\"vlt-type\">\r\n                File\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"vlt-right-panel\">\r\n        <h3 class=\"top-0\">");
  stack1 = helpers._triageMustache.call(depth0, "name", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program7(depth0,data) {
  ...
  data.buffer.push("<div class=\"vlt-author col-md-9 pull-left\">\r\n    <div class=\"vlt-footer-item help-block\">\r\n        ");
