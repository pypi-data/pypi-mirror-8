    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('me_in_first_subsession_object_id', otree.db.models.PositiveIntegerField(null=True)),
                ...
                ('_current_user_code', otree.db.models.CharField(max_length=500, null=True)),
                ('_current_app_name', otree.db.models.CharField(max_length=500, null=True)),
                ...
                ('me_in_first_subsession_content_type', models.ForeignKey(related_name='session_participant', to='contenttypes.ContentType', null=True)),
            ],
            options={
                'ordering': ['pk'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_started', otree.db.models.DateTimeField(null=True)),
                ('first_subsession_object_id', otree.db.models.PositiveIntegerField(null=True)),
                ...
                ('first_subsession_content_type', models.ForeignKey(related_name='session_session', to='contenttypes.ContentType', null=True)),
            ],
            options={
                'ordering': ['pk'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_current_user_code', otree.db.models.CharField(max_length=500, null=True)),
                ('_current_app_name', otree.db.models.CharField(max_length=500, null=True)),
                ('me_in_first_subsession_content_type', models.ForeignKey(related_name='session_sessionexperimenter', to='contenttypes.ContentType', null=True)),
            ],
            options={
                'abstract': False,
            },
