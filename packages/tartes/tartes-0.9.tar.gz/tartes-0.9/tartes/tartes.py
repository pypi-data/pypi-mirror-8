...
def albedo(wavelength, SSA, density, thickness=None,g0=default_g0,B0=default_B0,y0=0.728,W0=0.0611,
...
def absorption_profile(wavelength, SSA, density, thickness=None,g0=default_g0,B0=default_B0,y0=0.728,W0=0.0611,
...
def irradiance_profiles(wavelength, z, SSA, density, thickness=None,g0=default_g0,B0=default_B0,y0=0.728,W0=0.0611,
...
def actinic_profile(wavelength, z, SSA, density, thickness=None,g0=default_g0,B0=default_B0,y0=0.728,W0=0.0611,
               impurities=0,impurities_type=Soot,soilalbedo=0.0,dir_frac=0,totflux=1.0,theta_inc=0):
...
"""
    ...
    if compute_irradiance_profiles or compute_actinic_profile:
        ...
        depth_total=zeros(nlyr+1)    
        depth_total[1:]=cumsum(depth)
        nearest_layer=searchsorted(depth_total,z,side="right") #number of the layer (1,2...)
    ...
    for i in range(0,N):
        ...
        if compute_irradiance_profiles or compute_actinic_profile:
            ...
            for nz0,z0 in enumerate(z): # it is probably possible to optimize this loop (-> array calculation)
                m = nearest_layer[nz0]
                dtaustar_z=(z0-depth_total[m-1])/(depth_total[m]-depth_total[m-1])*dtaustar_ub[i,m-1]
