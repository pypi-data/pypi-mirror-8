"""
    ...
    import time of TermUI down, some infrequently used functionality is placed
...
from .exceptions import TermUIException
...
class Editor(object):
    ...
    def edit_file(self, filename):
        ...
        try:
            ...
            exit_code = c.wait()
            if exit_code != 0:
                raise TermUIException('%s: Editing failed!' % editor)
        except OSError as e:
            raise TermUIException('%s: Editing failed: %s' % (editor, e))
