...
class SOP2SIF(Interactions):
    ...
    For now, this function has been tested and used on the copy/paste of a PDF document
    ...
    def _translate(self):
        ...
        print("Parsing done. Found %s reactions." % len(self.specID))
    ...
    def sop2sif(self, include_and_gates=True):
        ...
        :param bool include_and_gates: if set to False, all reactions with AND
            gates are removed.
        :returns: an instance of :class:`cellnopt.core.sif.SIF`
