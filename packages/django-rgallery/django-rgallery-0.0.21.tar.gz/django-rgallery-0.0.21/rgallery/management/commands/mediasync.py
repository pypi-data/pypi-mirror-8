    ...
    def handle(self, *app_labels, **options):
        ...
        for file in bucket:
            ...
            try:
                ...
                nombre_imagen = str(os.path.basename(filepath)).replace('/', '').replace(' ','_').replace(':','-')
                ...
                if os.path.exists(destdir + '/' + nombre_imagen) == False:
                    ...
                    descargadas += 1
                    nombre_imagen_repe = str(os.path.basename(filepath)).replace('/','').replace(' ','_').replace(':','-').replace('.jpg','') + '_1.jpg'
