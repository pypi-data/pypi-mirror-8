 ...
 */
(function($) {
    $.fn.collapsiblePanel = function (cmd, arg) {
        ...
        if (typeof cmd == 'string') {
            return $.fn.collapsiblePanel.dispatcher[cmd](this, arg);
        }
        
        //return the command dispatcher
        return $.fn.collapsiblePanel.dispatcher['_create'](this, cmd);
    };

    //create the command dispatcher
    $.fn.collapsiblePanel.dispatcher = {
    ...
    function createCollapsible(obj, options)
    {
        ...
        var opts = $.extend({}, $.fn.collapsiblePanel.defaults, options);
