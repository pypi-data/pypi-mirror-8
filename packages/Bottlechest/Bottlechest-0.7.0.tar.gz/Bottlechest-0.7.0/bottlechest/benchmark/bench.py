...
def benchsuite(mode, shapes, dtype, axis, nans):
    ...
    def getsetups(setup, shapes, nans):
        ...
        import bottlechest as bn
        from bottlechest.benchmark.bench import getarray
    ...
    setup = """
        from bottlechest.slow.func import scipy_nanmedian
    ...
    setup = """
        from bottlechest.slow.func import scipy_nanmean
    ...
    setup = """
        from bottlechest.slow.func import scipy_nanstd
    ...
    setup = """
        from bottlechest.slow.func import scipy_ss
    ...
    setup = """
        from bottlechest.slow.func import replace
    ...
    setup = """
        from bottlechest.slow.move import move_sum as scipy_move_sum
        w = a.shape[AXIS] // 5
    ...
    setup = """
        from bottlechest.slow.move import move_nansum as scipy_move_nansum
        w = a.shape[AXIS] // 5
    ...
    setup = """
        from bottlechest.slow.move import move_mean as scipy_move_mean
        w = a.shape[AXIS] // 5
    ...
    setup = """
        from bottlechest.slow.move import move_nanmean as scipy_move_nanmean
        w = a.shape[AXIS] // 5
    ...
    setup = """
        from bottlechest.slow.move import move_std as scipy_move_std
        w = a.shape[AXIS] // 5
    ...
    setup = """
        from bottlechest.slow.move import move_nanstd as scipy_move_nanstd
        w = a.shape[AXIS] // 5
    ...
    setup = """
        from bottlechest.slow.move import move_max as scipy_move_max
        w = a.shape[AXIS] // 5
    ...
    setup = """
        from bottlechest.slow.move import move_nanmax as scipy_move_nanmax
        w = a.shape[AXIS] // 5
