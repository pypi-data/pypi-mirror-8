...
<html>
  <body>
    <script>
      window.top.location = "https://www.facebook.com/v1000/dialog/oauth?client_id=1234567890&display=page&redirect_uri=http%3A%2F%2Fapps.facebook.com%2Ffacebook%2Foauth%3Ffetchez%3Dla%2Bvache&response_type=code&scope=publish_actions,email&canvas=1";
    </script>
  </body>
</html>"""
