...
This documentation is for sphinxgen |release|.


Project Resources
------------------------
* `sphinxgen project homepage (bitbucket) <https://bitbucket.org/bmearns/sphinxgen>`_
* `sphinxgen on pypi <https://pypi.python.org/pypi/sphinxgen>`_
