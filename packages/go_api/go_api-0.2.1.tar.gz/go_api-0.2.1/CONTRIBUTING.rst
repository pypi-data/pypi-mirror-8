How to contribute to the Vumi Go API toolkit
============================================

The Vumi Go API toolkit is an Open Source software project under the
BSD license.  We love contributions!
...
2.  Run the tests, we'll only accept pull requests with passing tests.
    Ensure that the tests run with ``trial go_api`` and that
