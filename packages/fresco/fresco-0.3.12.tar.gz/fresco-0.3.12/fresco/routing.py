...
class Route(object):
    ...
    def __init__(self, pattern, methods, view, kwargs=None,
        ...
        :param decorators:  Decorator functions to apply to the view callable
                            before invoking it
        :param **_kwargs:   Other keyword aruments passed through to the view
                            callable.
...
class RouteCollection(object):
    ...
    def add_route(self, route):
        ...
        try:
            ...
            # If view methods are referenced by name in a class's __routes__
            # attribute, and the class has not yet been instantiated, this will
            # fail. However the view.url method is now deprecated, so we
