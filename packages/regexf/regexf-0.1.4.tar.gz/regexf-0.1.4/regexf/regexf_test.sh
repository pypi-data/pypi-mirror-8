...
assertEqual "regexf aa/bb/cc" "$configFile:re.match<aa/bb/cc> no_match"
assertFalse "regexf aa/bb/cc"
assertEqual "regexf aa/bb/cc vac/bb/cc" "$configFile:re.match<aa/bb/cc> no_match"
...
assertTrue "regexf vac/vac1/1 vac/vac2/2" # matches return True
assertFalse "regexf aa/bb/cc vac/vac1/1 vac/vac2/2" # 1 no_match return False
assertFalse "regexf vac/vac1/1 aa/bb/cc vac/vac2/2" # 1 no_match return False

#configFile=regexf.ini
assertGrep "regexf -f $configFile -s test1 -i" "test1"
assertGrep "regexf -f $configFile -s test1 a/d/g -v" "match"
assertGrep "regexf -f $configFile -s test1 d/d/g -v" " no_match"
assertGrep "regexf -f $configFile -s ego_test V1:A_B/bb/cc -v" " match"
assertGrep "regexf -f $configFile -s ego_test V2:A_B/bb/cc -v" " no_match"

test_file=/usr/local/bin/regexf_test.ini
assertEqual "regexf -f $test_file aa/bb/cc" "$test_file:re.match<aa/bb/cc> no_match"
assertFalse "regexf -f $test_file aa/bb/cc"
assertEqual "regexf -f $test_file m/bb/cc" ""
