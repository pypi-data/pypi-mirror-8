...
def setup_product():
    ...
    import Products.mediaPerson
    zcml.load_config('configure.zcml', Products.mediaPerson)
    ...
    ztc.installPackage('Products.mediaPerson')
...
setup_product()
ptc.setupPloneSite(products=['Products.mediaPerson'])
