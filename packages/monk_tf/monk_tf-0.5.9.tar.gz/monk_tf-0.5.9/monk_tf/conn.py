...
class NoPromptException(ConnectionException):
    """ is raised when no prompt could be retreived on time
    """
    pass
...
class ConnectionBase(object):
    ...
    def wait_for_prompt(self, timeout=None):
        ...
        timeout = timeout or self.first_prompt_timeout
        ...
        raise NoPromptException(
                "could not retreive prompt in {} seconds".format(timeout))
