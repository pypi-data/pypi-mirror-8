...
class OneDControllerTimer(OneDController):
    ...
    axis_attributes = {
        ...
        'IntegrationTime' : { 
            Type : float,
            FGet : 'getIntegrationTime', 
            FSet : 'setIntegrationTime',        
            Description : 'IntegrationTime',
            DefaultValue : '1.0' },
    }
    ...
    def GetAxisAttributes(self, axis):
        ...
        attrs = super(OneDControllerTimer, self).GetAxisAttributes(axis)
    ...
    def getIntegrationTime(self, axis):
        return self.integ_time
    
    def setIntegrationTime(self, axis, value):
        self.integ_time = value
