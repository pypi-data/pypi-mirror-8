...
"""
    ...
    def path_func(ll):
        path = os.path.join(
            SixyIO._fse_to_u_safe(i18n_dir),
            SixyIO._cae_to_u_safe(ll) + I18n.TT_FILE_EXT_UTXT
        )
        return path
    ...
    if tmp_args_obj.show_locale_choices:
        ...
        for ll in I18n.get_locale_choices(i18n_dir):
            sio.stderr_print_safe(SixyIO._fse_to_u_safe(ll)) 
