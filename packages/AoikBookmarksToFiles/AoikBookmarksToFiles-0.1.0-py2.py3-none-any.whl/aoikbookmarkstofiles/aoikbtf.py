...
"""
        ...
        SixyIO._stderr_write_safe(msg, encoding=SixyIO.LOCALE_ENCODING)
    ...
    if not output_dir_path_stxt:
        ...
        try:
            ...
            if sio.cae != SixyIO.LOCALE_ENCODING:
                sio.stderr_print_fmt_safe(tt('Hvvw6GN'), SixyIO.LOCALE_ENCODING)
            
            #/
            if debug_on:
                sio.stderr_print_fmt_safe(tt('HlO9FRk'), SixyIO.get_traceback_utxt())
