...
class SixyIO(object):
    ...
    def __init__(self,
        ...
        cae: command argument encoding. By default: cae or self.stdie
        ...
        try:
            ...
            #/
            SixyIO._stderr_write_tb_safe(msg, encoding=SixyIO.STDEE)
        ...
        try:
            ...
            #/
            SixyIO._stderr_write_tb_safe(msg, encoding=self.stdee)
    ...
    def get_native_encodings_info():
        ...
        txt_s.append(SixyIO.format(u'{:<25}{}', u'PYTHONIOENCODING', SixyIO._cae_to_u_safe(os.environ.get('PYTHONIOENCODING') or u'')))
...
%-25s%s""" % (
    ...
    @staticmethod
    def _stdout_write_tb_safe(utxt=None, fmt=None, encoding=None):
        #/
        if SixyIO.DEBUG_ON:
        ...
        #/
        SixyIO._stdout_write_safe(res_utxt, encoding=encoding)
        
    def stdout_write_tb_safe(self, utxt=None, fmt=None, encoding=None):
        encoding = encoding or self.stdoe
        
        SixyIO._stdout_write_tb_safe(utxt=utxt, fmt=fmt, encoding=encoding)
    ...
    @staticmethod
    def _stderr_write_safe(utxt, encoding=None, errors=None):
    ...
    @staticmethod
    def _stderr_write_tb_safe(utxt=None, fmt=None, encoding=None):
        #/
        if SixyIO.DEBUG_ON:
            assert utxt is None or SixyIO.is_u(utxt)
        ...
        #/
        SixyIO._stderr_write_safe(res_utxt, encoding=encoding)
        
    def stderr_write_tb_safe(self, utxt=None, fmt=None, encoding=None):
        encoding = encoding or self.stdee
        
        SixyIO._stderr_write_tb_safe(utxt=utxt, fmt=fmt, encoding=encoding)
    ...
    @staticmethod
    def to_u_safe(obj, encoding=None, errors='replace'):
        return SixyIO.to_u(obj, encoding, errors)
        
    @staticmethod
    def _cae_to_u(txt, errors=None):
        return SixyIO.to_u(txt, encoding=SixyIO.CAE, errors=errors)
        
    @staticmethod
    def _cae_to_u_safe(txt, errors='replace'):
        return SixyIO._cae_to_u(txt, errors=errors)
        
    def cae_to_u(self, txt, errors=None):
        return SixyIO.to_u(txt, encoding=self.cae, errors=errors)
            
    def cae_to_u_safe(self, txt, errors='replace'):
        return self.cae_to_u(txt, errors=errors)
        
    @staticmethod
    def _fse_to_u(txt, errors='strict'):
    ...
    @staticmethod
    def _fse_to_u_safe(txt):
        return SixyIO._fse_to_u(txt, errors='replace')
