...
class BulkApiMixin(object):
    ...
    def new_shim(self, config):
        ...
        configuration has already been registered the correspondig identifier
        is returned instead.

        :param config: Shim configuration dict.
        :returns: A dict which contains the shim identifier.
    ...
    def get_user_shims(self, type=None):
        ...
        :returns: A list which contains the shims as a dict.
    ...
    def new_shim_objects(self, shim_id, job_id, objects, force=False,
        ...
        :returns: A dict which contains information about processed objects.
    ...
    def new_shim_object(self, shim_id, job_id, object_config, force=False):
        ...
        :returns: A dict which contains information about the processed object.
    ...
    def get_shim_object(self, shim_id, object_ext_id):
        ...
        :returns: A dict which contains information about the object.
    ...
    def get_bulk_object_signals(self, object_id, keys=None):
        ...
        :returns: A dict which contains the object signals.
    ...
    def new_shim_job(self, shim_id):
        ...
        :param shim_id: Shim identifier.
        :returns: A dict which contais the job identifier to be used for
            future operations.
    ...
    def get_shim_job(self, shim_id, job_id):
        ...
        :returns: A dict which contains information about the job.
    ...
    def update_shim_job(self, shim_id, job_id, data):
        ...
        :param shim_id: Shim identifier.
        :param job_id: Job identifier.
        :param data: A dict which can contain the following keys:
    ...
    def new_shim_items(self, shim_id, job_id, source_id, source_secret, items):
        ...
        :returns: A dict which contains information about processed items.
