...
from .exceptions import InputDataError, AuthenticationError, \
    ...
    UnknownError, ClientError, ConflictError
...
class SquirroClient(UserApiMixin, TopicApiMixin, BulkApiMixin):
    ...
    def _perform_authentication(self, data):
        ...
        try:
            ...
            r = self._requests.post(url, data=data, headers=HEADERS, **params)
    ...
    def _new_session(self):
        ...
        Squirro platform. The session is available from the class variable
        `self.session`.
        """
    ...
    def _perform_request(self, method, url, **kwargs):
        ...
        for retry_count in range(2):
            ...
            res = func(url.encode('utf-8'), **kwargs)
    ...
    def _refresh_tokens(self):
        ...
        try:
            self.authenticate(refresh_token=self.refresh_token)
            ret = True
        except Exception as ex:
