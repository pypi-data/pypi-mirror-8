...
make_member_access.short_description = 'Give member access to selected questions'
...
make_public_access.short_description = 'Give public access to selected questions'
