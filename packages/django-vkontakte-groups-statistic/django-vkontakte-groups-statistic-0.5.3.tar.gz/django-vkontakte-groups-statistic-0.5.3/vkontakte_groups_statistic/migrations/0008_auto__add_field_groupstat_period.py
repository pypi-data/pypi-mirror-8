...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupStat.period'
        db.add_column('vkontakte_groups_groupstat', 'period',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding index on 'GroupStatistic', fields ['fetched']
        db.create_index('vkontakte_groups_groupstatistic', ['fetched'])


    def backwards(self, orm):
        # Removing index on 'GroupStatistic', fields ['fetched']
        db.delete_index('vkontakte_groups_groupstatistic', ['fetched'])

        # Deleting field 'GroupStat.period'
