...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupStat.sources_links'
        db.add_column('vkontakte_groups_groupstat', 'sources_links',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupStat.sources_links'
    ...
    models = {
        ...
        u'vkontakte_groups_statistic.groupstat': {
            'Meta': {'unique_together': "(('group', 'date', 'period'),)", 'object_name': 'GroupStat', 'db_table': "'vkontakte_groups_groupstat'"},
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'statistics'", 'to': u"orm['vkontakte_groups.Group']"}),
            ...
            'sources_audio': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            ...
            'sources_links': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
        ...
        u'vkontakte_groups_statistic.groupstatistic': {
            'Meta': {'unique_together': "(('group', 'date'),)", 'object_name': 'GroupStatistic', 'db_table': "'vkontakte_groups_groupstatistic'"},
            'age_18': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'age_18_21': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'age_21_24': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'age_24_27': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            ...
            'females': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'fetched': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'statistics_api'", 'to': u"orm['vkontakte_groups.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'males': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'views': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'visitors': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'})
        },
        u'vkontakte_groups_statistic.groupstatpercentage': {
            'Meta': {'unique_together': "(('group', 'type', 'value_type'),)", 'object_name': 'GroupStatPercentage', 'db_table': "'vkontakte_groups_groupstatpercentage'"},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'percentage_statistics'", 'to': u"orm['vkontakte_groups.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
