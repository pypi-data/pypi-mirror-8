...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GroupStat.traffic_ads'
        ...
        # Deleting field 'GroupStat.traffic_recomendation'
        db.delete_column('vkontakte_groups_groupstat', 'traffic_recomendation')

        # Deleting field 'GroupStat.traffic_special_offers'
        ...
        # Deleting field 'GroupStat.traffic_community_widget'
        ...
        # Adding field 'GroupStat.sources_ads'
        db.add_column('vkontakte_groups_groupstat', 'sources_ads',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_search_systems'
        db.add_column('vkontakte_groups_groupstat', 'sources_search_systems',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_external_sites'
        db.add_column('vkontakte_groups_groupstat', 'sources_external_sites',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_my_groups'
        db.add_column('vkontakte_groups_groupstat', 'sources_my_groups',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_recomendation'
        db.add_column('vkontakte_groups_groupstat', 'sources_recomendation',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_news'
        db.add_column('vkontakte_groups_groupstat', 'sources_news',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_top'
        db.add_column('vkontakte_groups_groupstat', 'sources_top',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_search_results'
        db.add_column('vkontakte_groups_groupstat', 'sources_search_results',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_users'
        db.add_column('vkontakte_groups_groupstat', 'sources_users',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_groups'
        db.add_column('vkontakte_groups_groupstat', 'sources_groups',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_applications'
        db.add_column('vkontakte_groups_groupstat', 'sources_applications',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_special_offers'
        db.add_column('vkontakte_groups_groupstat', 'sources_special_offers',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_community_widget'
        db.add_column('vkontakte_groups_groupstat', 'sources_community_widget',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.sources_favorites'
        db.add_column('vkontakte_groups_groupstat', 'sources_favorites',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'GroupStat.traffic_recomendation'
        db.add_column('vkontakte_groups_groupstat', 'traffic_recomendation',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.traffic_special_offers'
        db.add_column('vkontakte_groups_groupstat', 'traffic_special_offers',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)
        ...
        # Adding field 'GroupStat.traffic_community_widget'
        db.add_column('vkontakte_groups_groupstat', 'traffic_community_widget',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'vkontakte_groups_statistic.groupstat': {
            ...
            'sources_ads': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_applications': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_community_widget': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_external_sites': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_favorites': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_groups': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_my_groups': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_news': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_recomendation': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_search_results': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_search_systems': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_special_offers': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_top': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'sources_users': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
