...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'GroupStatistic', fields ['group', 'date']
        ...
        # Adding unique constraint on 'GroupStat', fields ['group', 'date']
        db.create_unique('vkontakte_groups_groupstat', ['group_id', 'date'])

        # Adding model 'GroupStatPercentage'
