...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'GroupStat', fields ['date', 'group']
        db.delete_unique('vkontakte_groups_groupstat', ['date', 'group_id'])

        # Adding unique constraint on 'GroupStat', fields ['date', 'group', 'period']
        db.create_unique('vkontakte_groups_groupstat', ['date', 'group_id', 'period'])


    def backwards(self, orm):
        # Removing unique constraint on 'GroupStat', fields ['date', 'group', 'period']
        db.delete_unique('vkontakte_groups_groupstat', ['date', 'group_id', 'period'])

        # Adding unique constraint on 'GroupStat', fields ['date', 'group']
    ...
    models = {
        ...
        u'vkontakte_groups_statistic.groupstat': {
            'Meta': {'ordering': "('group', 'period', 'date')", 'unique_together': "(('group', 'date', 'period'),)", 'object_name': 'GroupStat', 'db_table': "'vkontakte_groups_groupstat'"},
