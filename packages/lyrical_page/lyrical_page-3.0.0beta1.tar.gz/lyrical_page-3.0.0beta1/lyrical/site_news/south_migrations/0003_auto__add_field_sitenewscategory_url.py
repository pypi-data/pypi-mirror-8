...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteNewsCategory.url'
        db.add_column(u'site_news_sitenewscategory', 'url',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteNewsCategory.url'
        db.delete_column(u'site_news_sitenewscategory', 'url')
