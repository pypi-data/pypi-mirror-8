...
__title__ = 'docker-registry-driver-fdsstorage'
__build__ = 0x000000

#__url__ = 'https://github.com/tobegit3hub/docker-registry-driver-fdsstorage'
__description__ = 'Docker registry driver fdsstorage'
