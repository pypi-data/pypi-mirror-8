...
* `Issue #313 <https://bitbucket.org/pypa/setuptools/issue/313>`_: Removed built-in support for subversion. Projects wishing to
  retain support for subversion will need to use a third party library. The
  extant implementation is being ported to `setuptools_svn
  <https://pypi.python.org/pypi/setuptools_svn>`_.
* `Issue #315 <https://bitbucket.org/pypa/setuptools/issue/315>`_: Updated setuptools to hide its own loaded modules during
...
* `Issue #312 <https://bitbucket.org/pypa/setuptools/issue/312>`_: Restored presence of pkg_resources API tests (doctest) to sdist.

---
9.0
---

* `Issue #314 <https://bitbucket.org/pypa/setuptools/issue/314>`_: Disabled support for ``setup_requires`` metadata to avoid issue
...
* `Pull Request #106 <https://bitbucket.org/pypa/setuptools/pull-request/106>`_: Now write ``setup_requires`` metadata.

---
8.3
---

* `Issue #311 <https://bitbucket.org/pypa/setuptools/issue/311>`_: Decoupled pkg_resources from setuptools once again.
