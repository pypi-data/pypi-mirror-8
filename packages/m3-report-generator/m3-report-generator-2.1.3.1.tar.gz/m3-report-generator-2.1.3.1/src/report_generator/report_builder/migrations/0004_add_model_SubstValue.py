...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'report_builder.substvalue': {
            'Meta': {'object_name': 'SubstValue'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'json_subst_values': ('django.db.models.fields.TextField', [], {}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subst_values'", 'to': "orm['report_builder.Report']"})
        },
