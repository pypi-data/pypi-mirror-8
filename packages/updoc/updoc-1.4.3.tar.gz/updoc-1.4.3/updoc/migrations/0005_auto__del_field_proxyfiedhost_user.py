...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProxyfiedHost.user'
        db.delete_column('updoc_proxyfiedhost', 'user_id')


    def backwards(self, orm):
        # Adding field 'ProxyfiedHost.user'
        db.add_column('updoc_proxyfiedhost', 'user',
    ...
    models = {
        ...
        'updoc.keyword': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255'})
        },
        'updoc.lastdocs': {
        ...
        'updoc.proxyfiedhost': {
            ...
            'host': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'proxy': ('django.db.models.fields.CharField', [], {'blank': 'True', 'default': "''", 'db_index': 'True', 'max_length': '255'})
        },
        'updoc.rewrittenurl': {
            'Meta': {'object_name': 'RewrittenUrl'},
            'dst': ('django.db.models.fields.CharField', [], {'blank': 'True', 'default': "''", 'db_index': 'True', 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'src': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['auth.User']", 'null': 'True'})
        },
        'updoc.rssitem': {
            ...
            'url': ('django.db.models.fields.URLField', [], {'db_index': 'True', 'max_length': '255'})
        },
        'updoc.rssroot': {
        ...
        'updoc.uploaddoc': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keywords': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['updoc.Keyword']", 'symmetrical': 'False', 'db_index': 'True'}),
            ...
            'uid': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50'}),
