...
Ext4.define('Ext4.ux.Spotlight', {
    ...
    createElements: function() {
        ...
        me.all = Ext4.create('Ext4.CompositeElement', [me.right, me.left, me.top, me.bottom]);
    },
    ...
    show: function(el, callback, scope) {
        ...
        if (!me.active) {
            ...
            me.all.setDisplayed('');
            me.active = true;
            Ext4.EventManager.onWindowResize(me.syncSize, me);
    ...
    hide: function(callback, scope) {
        ...
        Ext4.EventManager.removeResizeListener(me.syncSize, me);
    ...
    applyBounds: function(animate, reverse) {
        var me = this,
            ...
            viewWidth = Ext4.Element.getViewWidth(true),
            viewHeight = Ext4.Element.getViewHeight(true),
            i = 0,
            config = false,
            from, to, clone;
        ...
        //reverse the objects
        if (reverse) {
            clone = Ext4.clone(from);
            from = to;
            to = clone;
        }

        if (animate) {
            Ext4.Array.forEach(['right', 'left', 'top', 'bottom'], function(side) {
            ...
            Ext4.Array.forEach(['right', 'left', 'top', 'bottom'], function(side) {
                me[side].setBox(Ext4.apply(from[side], to[side]));
                me[side].repaint();
            },
            this);
        }
    ...
    destroy: function() {
        ...
        Ext4.destroy(me.right, me.left, me.top, me.bottom);
        delete me.el;
        delete me.all;
    }
});
