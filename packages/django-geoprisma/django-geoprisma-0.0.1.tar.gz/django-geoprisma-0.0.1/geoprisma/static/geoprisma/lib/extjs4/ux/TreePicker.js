/**
 * @class Ext4.ux.TreePicker
 * @extends Ext4.form.field.Picker
 * 
 * A Picker field that contains a tree panel on its popup, enabling selection of tree nodes.
 */
Ext4.define('Ext4.ux.TreePicker', {
    extend: 'Ext4.form.field.Picker',
    xtype: 'treepicker',

    triggerCls: Ext4.baseCSSPrefix + 'form-arrow-trigger',

    config: {
        /**
         * @cfg {Ext4.data.TreeStore} store
         ...
         * Defaults to the default value of {@link Ext4.tree.Panel}'s `displayField` configuration.
         */
        displayField: null,
    ...
    initComponent: function() {
        ...
        this.addEvents(
             ...
             * @param {Ext4.ux.TreePicker} picker        This tree picker
             * @param {Ext4.data.Model} record           The selected record
             */
            'select'
        );
    ...
    createPicker: function() {
        var me = this,
            picker = Ext4.create('Ext4.tree.Panel', {
                store: me.store,
                floating: true,
                hidden: true,
                ...
                manageHeight: false,
                listeners: {
                    itemclick: Ext4.bind(me.onItemClick, me)
                },
                viewConfig: {
                    listeners: {
     ...
     * @private
     * @param {Ext4.tree.View} view
     * @param {Ext4.data.Model} record
     * @param {HTMLElement} node
     * @param {Number} rowIndex
     * @param {Ext4.EventObject} e
     */
     ...
     * @param {Mixed} value
     * @return {Ext4.ux.TreePicker} this
     */
