 ...
 * to provide a response given a {@link Ext4.ux.ajax.SimXhr} instance.
 */
Ext4.define('Ext4.ux.ajax.Simlet', function () {
    var urlRegex = /([^?#]*)(#.*)?$/,
    ...
    return {
        ...
        doGet: function (ctx) {
            ...
            Ext4.each(me.responseProps, function (prop) {
                if (prop in me) {
                    ret[prop] = me[prop];
                }
            });
         ...
         *
         * @param {Ext4.ux.ajax.SimXhr} xhr The simulated XMLHttpRequest instance.
         * @returns {Object} The response properties to add to the XMLHttpRequest.
         */
        exec: function (xhr) {
            var me = this,
                ret = {},
                method = 'do' + Ext4.String.capitalize(xhr.method.toLowerCase()), // doGet
                fn = me[method];
        ...
        redirect: function (method, url, params) {
            ...
            if (params) {
                url = Ext4.urlAppend(url, Ext4.Object.toQueryString(params));
            }
