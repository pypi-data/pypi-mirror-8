/**
 * @class Ext4.ux.grid.filter.DateFilter
 * @extends Ext4.ux.grid.filter.Filter
 * Filter by a configurable Ext4.picker.DatePicker menu
 ...
 * </code></pre>
 */
Ext4.define('Ext4.ux.grid.filter.DateFilter', {
    extend: 'Ext4.ux.grid.filter.Filter',
    alias: 'gridfilter.date',
    uses: ['Ext4.picker.Date', 'Ext4.menu.Menu'],
    ...
    /**
     * @cfg {Date} maxDate
     * Allowable date as passed to the Ext4.DatePicker
    ...
    init : function (config) {
        ...
        pickerCfg = Ext4.apply(me.pickerOpts, {
            xtype: 'datepicker',
            minDate: me.minDate,
            maxDate: me.maxDate,
        ...
        for (i = 0, len = me.menuItems.length; i < len; i++) {
            ...
            if (item !== '-') {
                ...
                item = me.fields[item] = Ext4.create('Ext4.menu.CheckItem', cfg);
            }
            //me.add(item);
            me.menu.add(item);
        }
        ...
        for (var key in this.fields) {
            if(this.fields[key].checked){
                args.push({
                    ...
                    value: Ext4.Date.format(this.getFieldValue(key), this.dateFormat)
                });
            }
        }
        return args;
