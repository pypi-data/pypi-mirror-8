/**
 * @class Ext4.ux.DataView.LabelEditor
 * @extends Ext4.Editor
 */
Ext4.define('Ext4.ux.DataView.LabelEditor', {
    ...
    constructor: function(config) {
        config.field = config.field || Ext4.create('Ext4.form.field.Text', {
            allowBlank: false,
            selectOnFocus:true
        });
    ...
    onClick: function(e, target) {
        ...
        if (Ext4.fly(target).hasCls(me.labelSelector) && !me.editing && !e.ctrlKey && !e.shiftKey) {
            e.stopEvent();
