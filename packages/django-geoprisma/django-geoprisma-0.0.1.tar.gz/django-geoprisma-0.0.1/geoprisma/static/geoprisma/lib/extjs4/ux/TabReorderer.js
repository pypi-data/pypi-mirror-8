 ...
 */
Ext4.define('Ext4.ux.TabReorderer', {

    extend: 'Ext4.ux.BoxReorderer',
    ...
    init: function(tabPanel) {
        ...
        tabPanel.onAdd = Ext4.Function.createSequence(tabPanel.onAdd, me.onAdd);
    },
    ...
    afterBoxReflow: function() {
        ...
        // Cannot use callParent, this is not called in the scope of this plugin, but that of its Ext4.dd.DD object
        Ext4.ux.BoxReorderer.prototype.afterBoxReflow.apply(me, arguments);
