/**
 * Base class from Ext4.ux.TabReorderer.
 */
Ext4.define('Ext4.ux.BoxReorderer', {
    mixins: {
     ...
     * A {@link Ext4.DomQuery DomQuery} selector which identifies the encapsulating elements of child
    ...
    constructor: function() {
        this.addEvents(
             ...
             * @param {Ext4.ux.BoxReorderer} this
             * @param {Ext4.container.Container} container The owning Container
             * @param {Ext4.Component} dragCmp The Component being dragged
             ...
             * @param {Ext4.ux.BoxReorderer} this
             * @param {Ext4.container.Container} container The owning Container
             * @param {Ext4.Component} dragCmp The Component being dropped
             * @param {Number} startIdx The index position from which the Component was initially dragged.
    ...
    afterFirstLayout: function() {
        ...
        // TODO: Ext45's DD classes should apply config to themselves.
        // TODO: Ext45's DD classes should not use init internally because it collides with use as a plugin
        // TODO: Ext45's DD classes should be Observable.
        // TODO: When all the above are trus, this plugin should extend the DD class.
        dd = me.dd = Ext4.create('Ext4.dd.DD', layout.innerCt, me.container.id + '-reorderer');
        Ext4.apply(dd, {
            animate: me.animate,
            reorderer: me,
            container: me.container,
            getDragCmp: this.getDragCmp,
            clickValidator: Ext4.Function.createInterceptor(dd.clickValidator, me.clickValidator, me, false),
    ...
    startDrag: function() {
        ...
        if (dragCmp) {
            ...
            dragCmp.setPosition = Ext4.emptyFn;
    ...
    endDrag: function(e) {
        ...
        if (me.dragCmp) {
            ...
            temp = Ext4.fx.Manager.getFxQueue(me.dragCmp.el.id)[0];
            if (temp) {
                temp.on({
            ...
            // If not animated, clean up after the mouseup has happened so that we don't click the thing being dragged
                ...
                Ext4.Function.defer(me.reorderer.afterBoxReflow, 1, me);
            }
    ...
    getNewIndex: function(pointerPos) {
        var me = this,
            dragEl = me.getDragEl(),
            dragBox = Ext4.fly(dragEl).getPageBox(),
            targetEl,
            targetBox,
            targetMidpoint,
            i = 0,
