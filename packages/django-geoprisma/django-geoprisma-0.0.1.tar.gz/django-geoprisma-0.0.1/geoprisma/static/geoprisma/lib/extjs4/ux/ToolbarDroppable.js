/**
 * @class Ext4.ux.ToolbarDroppable
 * @extends Object
 ...
 * <pre>
 * Ext4.create('Ext4.ux.ToolbarDroppable', {
 *   createItem: function(data) {
 *     return Ext4.create('Ext4.Button', {text: data.text});
 *   }
 * });
 * </pre>
 ...
 */
 Ext4.define('Ext4.ux.ToolbarDroppable', {
     ...
     * @param {Ext4.toolbar.Toolbar} toolbar The toolbar instance
     */
    init: function(toolbar) {
      /**
       * @property toolbar
       * @type Ext4.toolbar.Toolbar
    ...
    createDropTarget: function() {
        /**
         * @property dropTarget
         * @type Ext4.dd.DropTarget
         * The drop target attached to the toolbar instance
         */
        this.dropTarget = Ext4.create('Ext4.dd.DropTarget', this.toolbar.getEl(), {
            notifyOver: Ext4.Function.bind(this.notifyOver, this),
            notifyDrop: Ext4.Function.bind(this.notifyDrop, this)
        });
    },
     ...
     * drag event
     * @param {Ext4.EventObject} e The event object
    ...
    createItem: function(data) {
        //<debug>
        Ext4.Error.raise("The createItem method must be implemented in the ToolbarDroppable plugin");
        //</debug>
    },
