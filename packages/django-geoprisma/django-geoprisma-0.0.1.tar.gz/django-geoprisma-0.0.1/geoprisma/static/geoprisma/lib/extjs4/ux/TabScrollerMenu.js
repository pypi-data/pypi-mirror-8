 ...
 */
Ext4.define('Ext4.ux.TabScrollerMenu', {
    alias: 'plugin.tabscrollermenu',

    requires: ['Ext4.menu.Menu'],
    ...
    pageSize: 10,
    /**
     * @cfg {Number} maxText How long should the title of each {@link Ext4.menu.Item} be.
     */
    maxText: 15,
    /**
    ...
    init: function(tabPanel) {
        ...
        tabPanel.on({
            render: function() {
                ...
                me.layout.overflowHandler.handleOverflow = Ext4.Function.bind(me.showButton, me);
                me.layout.overflowHandler.clearOverflow = Ext4.Function.createSequence(me.layout.overflowHandler.clearOverflow, me.hideButton, me);
            },
            single: true
        });
    },
    ...
    showButton: function() {
        var me = this,
            result = Ext4.getClass(me.layout.overflowHandler).prototype.handleOverflow.apply(me.layout.overflowHandler, arguments);

        if (!me.menuButton) {
            me.menuButton = me.tabBar.body.createChild({
                cls: Ext4.baseCSSPrefix + 'tab-tabmenu-right'
            }, me.tabBar.body.child('.' + Ext4.baseCSSPrefix + 'box-scroller-right'));
            me.menuButton.addClsOnOver(Ext4.baseCSSPrefix + 'tab-tabmenu-over');
    ...
    generateTabMenuItems: function() {
        ...
        allItems = Ext4.Array.filter(allItems, function(item){
    ...
    autoGenMenuItem: function(item) {
        var maxText = this.getMaxText(),
            text = Ext4.util.Format.ellipsis(item.title, maxText);
