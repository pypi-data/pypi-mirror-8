/**
 * @class Ext4.ux.DataView.DragSelector
 * @extends Object
 * @author Ed Spencer
 * 
 */
Ext4.define('Ext4.ux.DataView.DragSelector', {
    requires: ['Ext4.dd.DragTracker', 'Ext4.util.Region'],
    ...
    onRender: function() {
         ...
         */
        this.tracker = Ext4.create('Ext4.dd.DragTracker', {
         ...
         */
        this.dragRegion = Ext4.create('Ext4.util.Region');
    },
     ...
     * @param {Ext4.EventObject} e The click event
     */
    onStart: function(e) {
     ...
     * @param {Ext4.EventObject} e The drag event
     */
    onDrag: function(e) {
        var dragSelector = this.dragSelector,
     ...
     */
    onEnd: Ext4.Function.createDelayed(function(e) {
     ...
     * @return {Ext4.Element} The Proxy element
     */
    getProxy: function() {
        if (!this.proxy) {
