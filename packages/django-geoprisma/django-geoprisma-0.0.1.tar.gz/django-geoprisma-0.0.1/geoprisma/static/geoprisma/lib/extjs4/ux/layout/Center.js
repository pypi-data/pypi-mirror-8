 ...
 * {@link Ext4.layout.container.Fit fit layout}, CenterLayout expects to have one child
 ...
 *
 *      var p = Ext4.create('Ext4.Container', {
 *          layout: 'ux.center',
 *          items: [{
 *              title: 'Centered Content',
 *              width: 300,
 ...
 *      });
 */
Ext4.define('Ext4.ux.layout.Center', {
    extend: 'Ext4.layout.container.Fit',
