 ...
 *
 * @class Ext4.ux.IFrame
 */
Ext4.define('Ext4.ux.IFrame', {
    ...
    initComponent: function () {
        ...
        Ext4.apply(this.renderSelectors, {
            iframeEl: 'iframe'
        });
    },
    ...
    initRenderData: function() {
        return Ext4.apply(this.callParent(), {
            src: this.src,
    ...
    beforeDestroy: function () {
        ...
        if (me.rendered) {
            try {
                doc = me.getDoc();
                if (doc) {
                    Ext4.EventManager.removeAll(doc);
                    for (prop in doc) {
    ...
    onLoad: function() {
        ...
        if (doc) {
            ...
            Ext4.EventManager.on(window, 'unload', me.beforeDestroy, me);
