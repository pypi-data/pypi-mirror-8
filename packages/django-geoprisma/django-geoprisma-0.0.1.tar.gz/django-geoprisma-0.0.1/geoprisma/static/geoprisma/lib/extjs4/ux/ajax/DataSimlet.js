 ...
 * group summary).
 */
Ext4.define('Ext4.ux.ajax.DataSimlet', function () {
    ...
    return {
        ...
        getData: function (ctx) {
            ...
            ctx.groupSpec = params.group && Ext4.decode(params.group);
            ...
            if (params.dir) {
                ...
                fields = Ext4.decode(params.sort);
            }
