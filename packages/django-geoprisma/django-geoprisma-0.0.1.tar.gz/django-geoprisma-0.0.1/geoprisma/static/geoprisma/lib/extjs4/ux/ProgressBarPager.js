/**
* @class Ext4.ux.ProgressBarPager
* @extends Object
...
*/
Ext4.define('Ext4.ux.ProgressBarPager', {

    requires: ['Ext4.ProgressBar'],
    /**
     * @cfg {Number} width
    ...
    * <p>The text to display while the store is loading.  Default is 'Loading...'</p>
     ...
     * <p>A {@link Ext4.fx.Anim Ext4.fx.Anim} configuration object.</p>
     */
    defaultAnimCfg : {
		duration: 1000,
		easing: 'bounceOut'	
    ...
    init : function (parent) {
        ...
        if (parent.displayInfo) {
            ...
            this.progressBar = Ext4.create('Ext4.ProgressBar', {
            ...
            Ext4.apply(parent, this.parentOverrides);
        }
    },
    // private
