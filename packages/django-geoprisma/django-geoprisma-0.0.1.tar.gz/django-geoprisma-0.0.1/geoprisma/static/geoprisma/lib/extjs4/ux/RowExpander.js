 ...
 * @ptype rowexpander
 */
Ext4.define('Ext4.ux.RowExpander', {
    extend: 'Ext4.AbstractPlugin',

    requires: [
        'Ext4.grid.feature.RowBody',
        'Ext4.grid.feature.RowWrap'
    ],
     ...
     * @param {Ext4.data.Model} record The record providing the data.
    ...
    constructor: function() {
        ...
        // <debug>
        if (!this.rowBodyTpl) {
            Ext4.Error.raise("The 'rowBodyTpl' config is required and is not defined.");
        }
        // </debug>
        // TODO: if XTemplate/Template receives a template as an arg, should
        // just return it back!
        var rowBodyTpl = Ext4.create('Ext4.XTemplate', this.rowBodyTpl),
            features = [{
                ftype: 'rowbody',
    ...
    bindView: function() {
        ...
        if (!view.rendered) {
            ...
            if (this.expandOnEnter) {
                this.keyNav = Ext4.create('Ext4.KeyNav', viewEl, {
                    'enter' : this.onEnter,
                    scope: this
                });
            }
    ...
    toggleRow: function(rowIdx) {
        var view = this.view,
            ...
            row = Ext4.get(rowNode),
            nextBd = Ext4.get(row).down(this.rowBodyTrSelector),
    ...
    getHeaderConfig: function() {
        var me                = this,
            toggleRow         = Ext4.Function.bind(me.toggleRow, me),
        ...
        return {
            ...
            hideable: false,
            menuDisabled: true,
            cls: Ext4.baseCSSPrefix + 'grid-header-special',
            renderer: function(value, metadata) {
                metadata.tdCls = Ext4.baseCSSPrefix + 'grid-cell-special';
