...
class DataDispatcher(threading.Thread):
        ...
        return { "AgentHeartbeatCommand": {                     \
                ...
                "config": {                                     \
                    "properties" : {                            \
                        ...
                        "syncPropsBeatInterval": self.flushInterval * 10 * 1000 \
                    }                                           \
                },                                              \
    ...
    def flushPendingItems(self):
        ...
        try:
            ...
            if self.logger.traceEnabled:
                for cmd in commands:
                    self.logger.debug("Sent %s" % json.dumps(cmd, sort_keys=True))
    ...
    def normalizeProperties(self, props):
        ...
        if not 'correlation' in props:
            props['correlation'] = "python-default-3777347-7365-%s" % (str((int) (time.time() * 1000000)))
        return props
