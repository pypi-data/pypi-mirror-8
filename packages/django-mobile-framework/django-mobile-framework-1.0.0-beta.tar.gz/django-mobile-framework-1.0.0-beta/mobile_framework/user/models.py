...
class AppUserBase(models.Model):
    ...
    """
    uuid = UUIDField(primary_key=True, auto=True, verbose_name=_('Unique ID'))
    user = models.OneToOneField(settings.AUTH_USER_MODEL, swappable=True, blank=True, related_name='app_user')
