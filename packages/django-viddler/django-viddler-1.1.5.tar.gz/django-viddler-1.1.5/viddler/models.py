...
def make_model_from_api(api_record, videoclass=ViddlerVideo):
    data_dict = dict(
        ...
        upload_time=datetime.datetime.utcfromtimestamp(int(api_record['upload_time']), tzinfo=utc),
    ...
    if made_public:
        data_dict['made_public_time'] = datetime.datetime.utcfromtimestamp(made_public, tzinfo=utc)
    tags = []
