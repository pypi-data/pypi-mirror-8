...
'''
    access2theMatrix is a tool for accessing Omicron NanoTechnology's MATRIX
    Control System result files. Only topography image data will be accessed
    by this tool.
'''
...
class MtrxData(access2thematrix.MtrxData):
    '''
        The tools to open result files and to select one out of the four
        images (forward/up, backward/up, forward/down and backward/down).
