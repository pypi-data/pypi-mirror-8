...
class CommandLineInterface(object):
    ...
    #: `Layout` class for the layout of the layout. (and the help text.)
    layout_factory = Layout
    ...
    def __init__(self, stdin=None, stdout=None):
        ...
        self.renderer = self.renderer_factory(layout=self.layout,
                                              stdout=self.stdout,
                                              style=self.style)
    ...
    def create_layout(self):
        ...
        """
        return self.layout_factory(weakref.ref(self))
