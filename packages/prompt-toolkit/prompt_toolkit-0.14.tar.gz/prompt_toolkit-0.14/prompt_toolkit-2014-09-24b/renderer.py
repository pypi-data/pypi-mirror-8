...
class Renderer(object):
    ...
    def render_to_str(self, cli, abort=False, accept=False):
        """
        ...
        self.layout.write_to_screen(cli, screen, height, abort=abort, accept=accept)
    ...
    def render(self, cli, abort=False, accept=False):
        # Render to string first.
        output = self.render_to_str(cli, abort=abort, accept=accept)
