...
_cffi_f_git_index_add_all(PyObject *self, PyObject *args)
{
  ...
  x3 = (int(*)(char const *, char const *, void *))_cffi_to_c_pointer(arg3, _cffi_type(29));
  ...
  if (datasize != 0) {
    ...
    x4 = alloca(datasize);
    memset((void *)x4, 0, datasize);
    if (_cffi_convert_array_from_object((char *)x4, _cffi_type(30), arg4) < 0)
      return NULL;
  }
...
_cffi_f_git_push_status_foreach(PyObject *self, PyObject *args)
{
  ...
  x1 = (int(*)(char const *, char const *, void *))_cffi_to_c_pointer(arg1, _cffi_type(29));
...
_cffi_f_git_refspec_direction(PyObject *self, PyObject *arg0)
{
  ...
  return _cffi_from_c_deref((char *)&result, _cffi_type(42));
}
...
PyMODINIT_FUNC
PyInit__cffi__x2fc1a35bx11893b76(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x2fc1a35bx11893b76(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x2fc1a35bx11893b76", _cffi_methods);
  if (lib == NULL)
    return;
  if (_cffi_const_GIT_REPOSITORY_INIT_SHARED_ALL(lib) < 0 || _cffi_init() < 0)
    return;
