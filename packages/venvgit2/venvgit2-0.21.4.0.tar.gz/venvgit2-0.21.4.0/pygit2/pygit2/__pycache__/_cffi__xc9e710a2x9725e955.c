...
PyMODINIT_FUNC
PyInit__cffi__xc9e710a2x9725e955(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__xc9e710a2x9725e955(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xc9e710a2x9725e955", _cffi_methods);
  if (lib == NULL)
    return;
  if (_cffi_const_GIT_REPOSITORY_INIT_SHARED_ALL(lib) < 0 || _cffi_init() < 0)
    return;
