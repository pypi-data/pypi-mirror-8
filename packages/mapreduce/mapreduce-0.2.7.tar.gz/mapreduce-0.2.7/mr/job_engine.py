...
# TODO(dustin): The invocation and request are being saved here (confirmed), 
#               but not found from the queue message-handlers if the current 
#               request terminates too soon (when we're running 
#               asynchronously).
    ...
    def process_request(self, message_parameters, block=True):
